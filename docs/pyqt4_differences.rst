...
:sip:ref:`~PyQt5.QtCore.QVariant` etc.).  With the exception of
:sip:ref:`~PyQt5.QtCore.QVariant`, PyQt5 only implements v2 of those APIs for
all versions of Python.  The changed support for
:sip:ref:`~PyQt5.QtCore.QVariant`, including the removal of
``QPyNullVariant``, is described in :ref:`ref-qvariant`.
...
- :meth:`~PyQt5.QtCore.QObject.disconnect` takes no arguments and disconnects
  all connections to the :sip:ref:`~PyQt5.QtCore.QObject` instance.
...
classes not sub-classed from :sip:ref:`~PyQt5.QtCore.QObject` (i.e. in
mixins).
...
supported.  These have been replaced by PyQt5's :sip:ref:`~PyQt5.QtQml` and
:sip:ref:`~PyQt5.QtQuick` modules.  Unlike PyQt4, PyQt5 supports the creation
of Python objects from QML.


``QtGui`` Module
----------------

PyQt4's ``QtGui`` module has been split into PyQt5's :sip:ref:`~PyQt5.QtGui`,
:sip:ref:`~PyQt5.QtPrintSupport` and :sip:ref:`~PyQt5.QtWidgets` modules.


``QtOpenGL`` Module
-------------------

Only the :sip:ref:`~PyQt5.QtOpenGL.QGLContext`,
:sip:ref:`~PyQt5.QtOpenGL.QGLFormat` and :sip:ref:`~PyQt5.QtOpenGL.QGLWidget`
...
PyQt4's ``QtWebKit`` module has been split into PyQt5's
:sip:ref:`~PyQt5.QtWebKit` and :sip:ref:`~PyQt5.QtWebKitWidgets` modules.
...
PyQt4's ``dbus.mainloop.qt`` module is called :sip:ref:`dbus.mainloop.pyqt5` in
...
:sip:ref:`~PyQt5.QtCore.QPropertyAnimation` instead.
...
:sip:ref:`~PyQt5.QtGui.QTransform` instead.

...
.. sip:class:: PyQt5.QtNetworkAuth.QOAuth1Signature
    :description: QtNetworkAuth/QOAuth1Signature-c.rst

    .. sip:enum:: PyQt5.QtNetworkAuth.QOAuth1Signature.HttpRequestMethod
        :description: QtNetworkAuth/QOAuth1Signature-HttpRequestMethod-e.rst

        .. sip:enum-member:: PyQt5.QtNetworkAuth.QOAuth1Signature.HttpRequestMethod.Custom
            :description: QtNetworkAuth/QOAuth1Signature-HttpRequestMethod-Custom-v.rst

        .. sip:enum-member:: PyQt5.QtNetworkAuth.QOAuth1Signature.HttpRequestMethod.Delete
            :description: QtNetworkAuth/QOAuth1Signature-HttpRequestMethod-Delete-v.rst

        .. sip:enum-member:: PyQt5.QtNetworkAuth.QOAuth1Signature.HttpRequestMethod.Get
            :description: QtNetworkAuth/QOAuth1Signature-HttpRequestMethod-Get-v.rst

        .. sip:enum-member:: PyQt5.QtNetworkAuth.QOAuth1Signature.HttpRequestMethod.Head
            :description: QtNetworkAuth/QOAuth1Signature-HttpRequestMethod-Head-v.rst

        .. sip:enum-member:: PyQt5.QtNetworkAuth.QOAuth1Signature.HttpRequestMethod.Post
            :description: QtNetworkAuth/QOAuth1Signature-HttpRequestMethod-Post-v.rst

        .. sip:enum-member:: PyQt5.QtNetworkAuth.QOAuth1Signature.HttpRequestMethod.Put
            :description: QtNetworkAuth/QOAuth1Signature-HttpRequestMethod-Put-v.rst

        .. sip:enum-member:: PyQt5.QtNetworkAuth.QOAuth1Signature.HttpRequestMethod.Unknown
            :description: QtNetworkAuth/QOAuth1Signature-HttpRequestMethod-Unknown-v.rst

    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.__init__
        :args:
            :sip:ref:`~PyQt5.QtNetworkAuth.QOAuth1Signature`
        :description: QtNetworkAuth/QOAuth1Signature-__init__-f.rst

    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.__init__
        :args:
            url: :sip:ref:`~PyQt5.QtCore.QUrl` = QUrl()
            method: :sip:ref:`~PyQt5.QtNetworkAuth.QOAuth1Signature.HttpRequestMethod` = :sip:ref:`~PyQt5.QtNetworkAuth.QOAuth1Signature.HttpRequestMethod.Post`
    ...
    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.addRequestBody
        :args:
            :sip:ref:`~PyQt5.QtCore.QUrlQuery`
        :description: QtNetworkAuth/QOAuth1Signature-addRequestBody-f.rst

    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.clientSharedKey
        :returns:
            str
    ...
    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.httpRequestMethod
        :returns:
            :sip:ref:`~PyQt5.QtNetworkAuth.QOAuth1Signature.HttpRequestMethod`
        :description: QtNetworkAuth/QOAuth1Signature-httpRequestMethod-f.rst

    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.insert
        :args:
            str
            Any
        :description: QtNetworkAuth/QOAuth1Signature-insert-f.rst

    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.keys
        :returns:
            List[str]
        :description: QtNetworkAuth/QOAuth1Signature-keys-f.rst

    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.parameters
        :returns:
            Dict[str, Any]
        :description: QtNetworkAuth/QOAuth1Signature-parameters-f.rst

    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.plainText
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
    ...
    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.rsaSha1
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: QtNetworkAuth/QOAuth1Signature-rsaSha1-f.rst

    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.setClientSharedKey
        :args:
            str
    ...
    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.setParameters
        :args:
            Dict[str, Any]
        :description: QtNetworkAuth/QOAuth1Signature-setParameters-f.rst

    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.setTokenSecret
        :args:
            str
        :description: QtNetworkAuth/QOAuth1Signature-setTokenSecret-f.rst

    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.setUrl
        :args:
            :sip:ref:`~PyQt5.QtCore.QUrl`
        :description: QtNetworkAuth/QOAuth1Signature-setUrl-f.rst

    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.swap
        :args:
            :sip:ref:`~PyQt5.QtNetworkAuth.QOAuth1Signature`
        :description: QtNetworkAuth/QOAuth1Signature-swap-f.rst

    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.take
        :args:
            str
        :returns:
            Any
    ...
    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.tokenSecret
        :returns:
            str
        :description: QtNetworkAuth/QOAuth1Signature-tokenSecret-f.rst

    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.url
        :returns:
            :sip:ref:`~PyQt5.QtCore.QUrl`
        :description: QtNetworkAuth/QOAuth1Signature-url-f.rst

    .. sip:method:: PyQt5.QtNetworkAuth.QOAuth1Signature.value
        :args:
            str

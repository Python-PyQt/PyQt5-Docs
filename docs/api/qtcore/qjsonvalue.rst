...
.. sip:class:: PyQt5.QtCore.QJsonValue
    :description: QtCore/QJsonValue-c.rst

    .. sip:enum:: PyQt5.QtCore.QJsonValue.Type
        :description: QtCore/QJsonValue-Type-e.rst

        .. sip:enum-member:: PyQt5.QtCore.QJsonValue.Type.Array
            :description: QtCore/QJsonValue-Type-Array-v.rst

        .. sip:enum-member:: PyQt5.QtCore.QJsonValue.Type.Bool
            :description: QtCore/QJsonValue-Type-Bool-v.rst

        .. sip:enum-member:: PyQt5.QtCore.QJsonValue.Type.Double
            :description: QtCore/QJsonValue-Type-Double-v.rst

        .. sip:enum-member:: PyQt5.QtCore.QJsonValue.Type.Null
            :description: QtCore/QJsonValue-Type-Null-v.rst

        .. sip:enum-member:: PyQt5.QtCore.QJsonValue.Type.Object
            :description: QtCore/QJsonValue-Type-Object-v.rst

        .. sip:enum-member:: PyQt5.QtCore.QJsonValue.Type.String
            :description: QtCore/QJsonValue-Type-String-v.rst

        .. sip:enum-member:: PyQt5.QtCore.QJsonValue.Type.Undefined
            :description: QtCore/QJsonValue-Type-Undefined-v.rst

    .. sip:method:: PyQt5.QtCore.QJsonValue.__init__
        :args:
            type: :sip:ref:`~PyQt5.QtCore.QJsonValue.Type` = :sip:ref:`~PyQt5.QtCore.QJsonValue.Type.Null`
    ...
    .. sip:method:: PyQt5.QtCore.QJsonValue.__getitem__
        :args:
            str
        :returns:
            :sip:ref:`~PyQt5.QtCore.QJsonValue`
    ...
    .. sip:method:: PyQt5.QtCore.QJsonValue.__hash__
        :returns:
            int
        :description: QtCore/QJsonValue-__hash__-f.rst

    .. sip:method:: PyQt5.QtCore.QJsonValue.isArray
        :returns:
            bool
        :description: QtCore/QJsonValue-isArray-f.rst

    .. sip:method:: PyQt5.QtCore.QJsonValue.isBool
        :returns:
            bool
        :description: QtCore/QJsonValue-isBool-f.rst

    .. sip:method:: PyQt5.QtCore.QJsonValue.isDouble
        :returns:
            bool
        :description: QtCore/QJsonValue-isDouble-f.rst

    .. sip:method:: PyQt5.QtCore.QJsonValue.isNull
        :returns:
            bool
        :description: QtCore/QJsonValue-isNull-f.rst

    .. sip:method:: PyQt5.QtCore.QJsonValue.isObject
        :returns:
            bool
        :description: QtCore/QJsonValue-isObject-f.rst

    .. sip:method:: PyQt5.QtCore.QJsonValue.isString
        :returns:
            bool
        :description: QtCore/QJsonValue-isString-f.rst

    .. sip:method:: PyQt5.QtCore.QJsonValue.isUndefined
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QJsonValue.toArray
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QJsonValue.toBool
        :args:
    ...
    .. sip:method:: PyQt5.QtCore.QJsonValue.toDouble
        :args:
    ...
    .. sip:method:: PyQt5.QtCore.QJsonValue.toInt
        :args:
            defaultValue: int = 0
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QJsonValue.toObject
        ...
        :description: QtCore/QJsonValue-toObject-f-4.rst
    ...
    .. sip:method:: PyQt5.QtCore.QJsonValue.toObject
        ...
        :returns:
            Dict[str, :sip:ref:`~PyQt5.QtCore.QJsonValue`]
        :description: QtCore/QJsonValue-toObject-f-5.rst
    ...
    .. sip:method:: PyQt5.QtCore.QJsonValue.toVariant
        :returns:
            Any
        :description: QtCore/QJsonValue-toVariant-f.rst

    .. sip:method:: PyQt5.QtCore.QJsonValue.type
        :returns:
            :sip:ref:`~PyQt5.QtCore.QJsonValue.Type`

...
.. sip:class:: PyQt5.QtCore.QTimeZone
    :description: QtCore/QTimeZone-c.rst

    .. sip:enum:: PyQt5.QtCore.QTimeZone.NameType
        :description: QtCore/QTimeZone-NameType-e.rst

        .. sip:enum-member:: PyQt5.QtCore.QTimeZone.NameType.DefaultName
            :description: QtCore/QTimeZone-NameType-DefaultName-v.rst

        .. sip:enum-member:: PyQt5.QtCore.QTimeZone.NameType.LongName
            :description: QtCore/QTimeZone-NameType-LongName-v.rst

        .. sip:enum-member:: PyQt5.QtCore.QTimeZone.NameType.OffsetName
            :description: QtCore/QTimeZone-NameType-OffsetName-v.rst

        .. sip:enum-member:: PyQt5.QtCore.QTimeZone.NameType.ShortName
            :description: QtCore/QTimeZone-NameType-ShortName-v.rst

    .. sip:enum:: PyQt5.QtCore.QTimeZone.TimeType
        :description: QtCore/QTimeZone-TimeType-e.rst

        .. sip:enum-member:: PyQt5.QtCore.QTimeZone.TimeType.DaylightTime
            :description: QtCore/QTimeZone-TimeType-DaylightTime-v.rst

        .. sip:enum-member:: PyQt5.QtCore.QTimeZone.TimeType.GenericTime
            :description: QtCore/QTimeZone-TimeType-GenericTime-v.rst

        .. sip:enum-member:: PyQt5.QtCore.QTimeZone.TimeType.StandardTime
            :description: QtCore/QTimeZone-TimeType-StandardTime-v.rst

    .. sip:method:: PyQt5.QtCore.QTimeZone.__init__
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.abbreviation
        :args:
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.availableTimeZoneIds
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.comment
        :returns:
            str
        :description: QtCore/QTimeZone-comment-f.rst

    .. sip:method:: PyQt5.QtCore.QTimeZone.country
        :returns:
            :sip:ref:`~PyQt5.QtCore.QLocale.Country`
        :description: QtCore/QTimeZone-country-f.rst

    .. sip:method:: PyQt5.QtCore.QTimeZone.daylightTimeOffset
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.displayName
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
            nameType: :sip:ref:`~PyQt5.QtCore.QTimeZone.NameType` = :sip:ref:`~PyQt5.QtCore.QTimeZone.NameType.DefaultName`
            locale: :sip:ref:`~PyQt5.QtCore.QLocale` = QLocale()
        :returns:
            str
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.displayName
        :args:
            :sip:ref:`~PyQt5.QtCore.QTimeZone.TimeType`
            nameType: :sip:ref:`~PyQt5.QtCore.QTimeZone.NameType` = :sip:ref:`~PyQt5.QtCore.QTimeZone.NameType.DefaultName`
            locale: :sip:ref:`~PyQt5.QtCore.QLocale` = QLocale()
        :returns:
            str
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.__eq__
        :args:
            :sip:ref:`~PyQt5.QtCore.QTimeZone`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.hasDaylightTime
        :returns:
            bool
        :description: QtCore/QTimeZone-hasDaylightTime-f.rst

    .. sip:method:: PyQt5.QtCore.QTimeZone.hasTransitions
        :returns:
            bool
        :description: QtCore/QTimeZone-hasTransitions-f.rst

    .. sip:method:: PyQt5.QtCore.QTimeZone.ianaIdToWindowsId
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.id
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: QtCore/QTimeZone-id-f.rst

    .. sip:method:: PyQt5.QtCore.QTimeZone.isDaylightTime
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.isTimeZoneIdAvailable
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.isValid
        :returns:
            bool
        :description: QtCore/QTimeZone-isValid-f.rst

    .. sip:method:: PyQt5.QtCore.QTimeZone.__ne__
        :args:
            :sip:ref:`~PyQt5.QtCore.QTimeZone`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.nextTransition
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            :sip:ref:`~PyQt5.QtCore.QTimeZone.OffsetData`
        :description: QtCore/QTimeZone-nextTransition-f.rst

    .. sip:method:: PyQt5.QtCore.QTimeZone.offsetData
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            :sip:ref:`~PyQt5.QtCore.QTimeZone.OffsetData`
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.offsetFromUtc
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.previousTransition
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            :sip:ref:`~PyQt5.QtCore.QTimeZone.OffsetData`
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.standardTimeOffset
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.swap
        :args:
            :sip:ref:`~PyQt5.QtCore.QTimeZone`
        :description: QtCore/QTimeZone-swap-f.rst

    .. sip:method:: PyQt5.QtCore.QTimeZone.systemTimeZone
        :returns:
            :sip:ref:`~PyQt5.QtCore.QTimeZone`
        :static:
        :description: QtCore/QTimeZone-systemTimeZone-f.rst

    .. sip:method:: PyQt5.QtCore.QTimeZone.systemTimeZoneId
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :static:
        :description: QtCore/QTimeZone-systemTimeZoneId-f.rst

    .. sip:method:: PyQt5.QtCore.QTimeZone.transitions
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            List[:sip:ref:`~PyQt5.QtCore.QTimeZone.OffsetData`]
        :description: QtCore/QTimeZone-transitions-f.rst

    .. sip:method:: PyQt5.QtCore.QTimeZone.utc
        :returns:
            :sip:ref:`~PyQt5.QtCore.QTimeZone`
        :static:
        :description: QtCore/QTimeZone-utc-f.rst

    .. sip:method:: PyQt5.QtCore.QTimeZone.windowsIdToDefaultIanaId
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
    ...
    .. sip:method:: PyQt5.QtCore.QTimeZone.windowsIdToIanaIds
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :returns:
            List[:sip:ref:`~PyQt5.QtCore.QByteArray`]

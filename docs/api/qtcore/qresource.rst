...
.. sip:class:: PyQt5.QtCore.QResource
    ...
    .. sip:method:: PyQt5.QtCore.QResource.absoluteFilePath
        :returns:
            str
        :description: QtCore/QResource-absoluteFilePath-f.rst

    .. sip:method:: PyQt5.QtCore.QResource.children
        :returns:
            List[str]
    ...
    .. sip:method:: PyQt5.QtCore.QResource.fileName
        :returns:
            str
        :description: QtCore/QResource-fileName-f.rst

    .. sip:method:: PyQt5.QtCore.QResource.isCompressed
        :returns:
            bool
        :description: QtCore/QResource-isCompressed-f.rst

    .. sip:method:: PyQt5.QtCore.QResource.isDir
        :returns:
            bool
        :description: QtCore/QResource-isDir-f.rst

    .. sip:method:: PyQt5.QtCore.QResource.isFile
        :returns:
            bool
        :description: QtCore/QResource-isFile-f.rst

    .. sip:method:: PyQt5.QtCore.QResource.isValid
        :returns:
            bool
        :description: QtCore/QResource-isValid-f.rst

    .. sip:method:: PyQt5.QtCore.QResource.lastModified
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
        :description: QtCore/QResource-lastModified-f.rst

    .. sip:method:: PyQt5.QtCore.QResource.locale
        :returns:
            :sip:ref:`~PyQt5.QtCore.QLocale`
        :description: QtCore/QResource-locale-f.rst

    .. sip:method:: PyQt5.QtCore.QResource.registerResource
        :args:
            str
            mapRoot: str = ''
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QResource.registerResourceData
        :args:
            bytes
            mapRoot: str = ''
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QResource.setFileName
        :args:
            str
        :description: QtCore/QResource-setFileName-f.rst

    .. sip:method:: PyQt5.QtCore.QResource.setLocale
        :args:
            :sip:ref:`~PyQt5.QtCore.QLocale`
        :description: QtCore/QResource-setLocale-f.rst

    .. sip:method:: PyQt5.QtCore.QResource.size
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QResource.unregisterResourceData
        :args:
            bytes
            mapRoot: str = ''
        :returns:

...
.. sip:class:: PyQt5.QtCore.QByteArray
    ...
    .. sip:enum:: PyQt5.QtCore.QByteArray.Base64Option
        ...
        .. sip:enum-member:: PyQt5.QtCore.QByteArray.Base64Option.OmitTrailingEquals
            :description: QtCore/QByteArray-Base64Option-OmitTrailingEquals-v.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.__init__
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.__add__
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.append
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.at
        :args:
            int
        :returns:
            str
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.capacity
        :returns:
            int
        :description: QtCore/QByteArray-capacity-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.chop
        :args:
            int
        :description: QtCore/QByteArray-chop-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.chopped
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.clear
        :description: QtCore/QByteArray-clear-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.compare
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.contains
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.__contains__
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.count
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.data
        :returns:
            bytes
        :description: QtCore/QByteArray-data-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.endsWith
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.__eq__
        :args:
            str
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.fill
        :args:
            str
            size: int = -1
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.fromBase64
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.fromBase64
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray.Base64Options`, :sip:ref:`~PyQt5.QtCore.QByteArray.Base64Option`]
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :static:
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.fromPercentEncoding
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
            percent: str = '%'
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.fromRawData
        :args:
            bytes
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :static:
        :description: QtCore/QByteArray-fromRawData-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.__ge__
        :args:
            str
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.__getitem__
        :args:
            int
        :returns:
            str
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.__gt__
        :args:
            str
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.__hash__
        :returns:
            int
        :description: QtCore/QByteArray-__hash__-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.__iadd__
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.__imul__
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.indexOf
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
            from: int = 0
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.insert
        :args:
            int
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.isEmpty
        :returns:
            bool
        :description: QtCore/QByteArray-isEmpty-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.isLower
        :returns:
            bool
        :description: QtCore/QByteArray-isLower-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.isNull
        :returns:
            bool
        :description: QtCore/QByteArray-isNull-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.isUpper
        :returns:
            bool
        :description: QtCore/QByteArray-isUpper-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.lastIndexOf
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
            from: int = -1
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.__le__
        :args:
            str
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.left
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.leftJustified
        :args:
            int
            fill: str = ' '
            truncate: bool = False
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.__len__
        :returns:
            int
        :description: QtCore/QByteArray-__len__-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.length
        :returns:
            int
        :description: QtCore/QByteArray-length-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.__lt__
        :args:
            str
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.mid
        :args:
            int
            length: int = -1
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.__mul__
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.__ne__
        :args:
            str
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.number
        :args:
            int
            base: int = 10
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.prepend
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.push_back
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :description: QtCore/QByteArray-push_back-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.push_front
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :description: QtCore/QByteArray-push_front-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.remove
        :args:
            int
            int
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.repeated
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.replace
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.__repr__
        :returns:
            str
        :description: QtCore/QByteArray-__repr__-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.reserve
        :args:
            int
        :description: QtCore/QByteArray-reserve-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.resize
        :args:
            int
        :description: QtCore/QByteArray-resize-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.right
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.rightJustified
        :args:
            int
            fill: str = ' '
            truncate: bool = False
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.setNum
        :args:
            int
            base: int = 10
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.simplified
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: QtCore/QByteArray-simplified-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.size
        :returns:
            int
        :description: QtCore/QByteArray-size-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.split
        :args:
            str
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.squeeze
        :description: QtCore/QByteArray-squeeze-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.startsWith
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.__str__
        :returns:
            str
        :description: QtCore/QByteArray-__str__-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.swap
        :args:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: QtCore/QByteArray-swap-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.toBase64
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.toDouble
        :returns:
            float
            bool
        :description: QtCore/QByteArray-toDouble-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.toFloat
        :returns:
            float
            bool
        :description: QtCore/QByteArray-toFloat-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.toHex
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.toInt
        :args:
            base: int = 10
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.toLong
        :args:
            base: int = 10
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.toLongLong
        :args:
            base: int = 10
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.toLower
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: QtCore/QByteArray-toLower-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.toPercentEncoding
        :args:
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.toShort
        :args:
            base: int = 10
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.toUInt
        :args:
            base: int = 10
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.toULong
        :args:
            base: int = 10
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.toULongLong
        :args:
            base: int = 10
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.toUpper
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: QtCore/QByteArray-toUpper-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.toUShort
        :args:
            base: int = 10
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QByteArray.trimmed
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: QtCore/QByteArray-trimmed-f.rst

    .. sip:method:: PyQt5.QtCore.QByteArray.truncate
        :args:
            int

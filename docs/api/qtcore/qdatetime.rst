...
.. sip:class:: PyQt5.QtCore.QDateTime
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.__init__
        :args:
            ...
            timeSpec: :sip:ref:`~PyQt5.QtCore.Qt.TimeSpec` = :sip:ref:`~PyQt5.QtCore.Qt.TimeSpec.LocalTime`
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.addDays
        :args:
            int
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.addMonths
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.addMSecs
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.addSecs
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.addYears
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.__bool__
        :returns:
            int
        :description: QtCore/QDateTime-__bool__-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.currentDateTime
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
        :static:
        :description: QtCore/QDateTime-currentDateTime-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.currentDateTimeUtc
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
        :static:
        :description: QtCore/QDateTime-currentDateTimeUtc-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.currentMSecsSinceEpoch
        :returns:
            int
        :static:
        :description: QtCore/QDateTime-currentMSecsSinceEpoch-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.currentSecsSinceEpoch
        :returns:
            int
        :static:
        :description: QtCore/QDateTime-currentSecsSinceEpoch-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.date
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDate`
        :description: QtCore/QDateTime-date-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.daysTo
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.__eq__
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.fromMSecsSinceEpoch
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.fromMSecsSinceEpoch
        ...
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
        :static:
        :description: QtCore/QDateTime-fromMSecsSinceEpoch-f-2.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.fromSecsSinceEpoch
        :args:
            int
            :sip:ref:`~PyQt5.QtCore.QTimeZone`
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.fromTime_t
        ...
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
        :static:
        :description: QtCore/QDateTime-fromTime_t-f.rst
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.fromTime_t
        ...
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
        :static:
        :description: QtCore/QDateTime-fromTime_t-f-1.rst
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.fromTime_t
        ...
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
        :static:
        :description: QtCore/QDateTime-fromTime_t-f-2.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.__ge__
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.__gt__
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.__hash__
        :returns:
            int
        :description: QtCore/QDateTime-__hash__-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.isDaylightTime
        :returns:
            bool
        :description: QtCore/QDateTime-isDaylightTime-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.isNull
        :returns:
            bool
        :description: QtCore/QDateTime-isNull-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.isValid
        :returns:
            bool
        :description: QtCore/QDateTime-isValid-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.__le__
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.__lt__
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.msecsTo
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.__ne__
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.offsetFromUtc
        :returns:
            int
        :description: QtCore/QDateTime-offsetFromUtc-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.__repr__
        :returns:
            str
        :description: QtCore/QDateTime-__repr__-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.secsTo
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDateTime`, datetime.datetime]
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.setDate
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDate`, datetime.date]
        :description: QtCore/QDateTime-setDate-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.setMSecsSinceEpoch
        :args:
            int
        :description: QtCore/QDateTime-setMSecsSinceEpoch-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.setOffsetFromUtc
        :args:
            int
        :description: QtCore/QDateTime-setOffsetFromUtc-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.setSecsSinceEpoch
        :args:
            int
        :description: QtCore/QDateTime-setSecsSinceEpoch-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.setTime
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QTime`, datetime.time]
        :description: QtCore/QDateTime-setTime-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.setTime_t
        :args:
            int
        :description: QtCore/QDateTime-setTime_t-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.setTimeSpec
        :args:
            :sip:ref:`~PyQt5.QtCore.Qt.TimeSpec`
        :description: QtCore/QDateTime-setTimeSpec-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.setTimeZone
        :args:
            :sip:ref:`~PyQt5.QtCore.QTimeZone`
        :description: QtCore/QDateTime-setTimeZone-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.swap
        :args:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
        :description: QtCore/QDateTime-swap-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.time
        :returns:
            :sip:ref:`~PyQt5.QtCore.QTime`
        :description: QtCore/QDateTime-time-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.timeSpec
        :returns:
            :sip:ref:`~PyQt5.QtCore.Qt.TimeSpec`
        :description: QtCore/QDateTime-timeSpec-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.timeZone
        :returns:
            :sip:ref:`~PyQt5.QtCore.QTimeZone`
        :description: QtCore/QDateTime-timeZone-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.timeZoneAbbreviation
        :returns:
            str
        :description: QtCore/QDateTime-timeZoneAbbreviation-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.toLocalTime
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
        :description: QtCore/QDateTime-toLocalTime-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.toMSecsSinceEpoch
        :returns:
            int
        :description: QtCore/QDateTime-toMSecsSinceEpoch-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.toOffsetFromUtc
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.toPyDateTime
        :returns:
            datetime.datetime
        :description: QtCore/QDateTime-toPyDateTime-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.toSecsSinceEpoch
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.toTime_t
        :returns:
            int
        :description: QtCore/QDateTime-toTime_t-f.rst

    .. sip:method:: PyQt5.QtCore.QDateTime.toTimeSpec
        :args:
            :sip:ref:`~PyQt5.QtCore.Qt.TimeSpec`
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.toTimeZone
        :args:
            :sip:ref:`~PyQt5.QtCore.QTimeZone`
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
    ...
    .. sip:method:: PyQt5.QtCore.QDateTime.toUTC
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`

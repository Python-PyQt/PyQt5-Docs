...
.. sip:class:: PyQt5.QtCore.QCalendar
    :description: QtCore/QCalendar-c.rst

    .. sip:enum:: PyQt5.QtCore.QCalendar.System
        :description: QtCore/QCalendar-System-e.rst

        .. sip:enum-member:: PyQt5.QtCore.QCalendar.System.Gregorian
            :description: QtCore/QCalendar-System-Gregorian-v.rst

        .. sip:enum-member:: PyQt5.QtCore.QCalendar.System.IslamicCivil
            :description: QtCore/QCalendar-System-IslamicCivil-v.rst

        .. sip:enum-member:: PyQt5.QtCore.QCalendar.System.Jalali
            :description: QtCore/QCalendar-System-Jalali-v.rst

        .. sip:enum-member:: PyQt5.QtCore.QCalendar.System.Julian
            :description: QtCore/QCalendar-System-Julian-v.rst

        .. sip:enum-member:: PyQt5.QtCore.QCalendar.System.Milankovic
            :description: QtCore/QCalendar-System-Milankovic-v.rst

    .. sip:attribute:: PyQt5.QtCore.QCalendar.Unspecified
        :type: int
        :const:
        :description: QtCore/QCalendar-Unspecified-a.rst

    .. sip:method:: PyQt5.QtCore.QCalendar.__init__
        :description: QtCore/QCalendar-__init__-f.rst

    .. sip:method:: PyQt5.QtCore.QCalendar.__init__
        :args:
            :sip:ref:`~PyQt5.QtCore.QCalendar.System`
    ...
    .. sip:method:: PyQt5.QtCore.QCalendar.availableCalendars
        :returns:
            List[str]
        :static:
        :description: QtCore/QCalendar-availableCalendars-f.rst

    .. sip:method:: PyQt5.QtCore.QCalendar.dateFromParts
        :args:
            :sip:ref:`~PyQt5.QtCore.QCalendar.YearMonthDay`
        :returns:
    ...
    .. sip:method:: PyQt5.QtCore.QCalendar.dateTimeToString
        :args:
            str
    ...
    .. sip:method:: PyQt5.QtCore.QCalendar.dayOfWeek
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDate`, datetime.date]
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QCalendar.daysInMonth
        :args:
            int
            year: int = :sip:ref:`~PyQt5.QtCore.QCalendar.Unspecified`
        :returns:
            int
        :description: QtCore/QCalendar-daysInMonth-f.rst

    .. sip:method:: PyQt5.QtCore.QCalendar.daysInYear
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QCalendar.hasYearZero
        :returns:
            bool
        :description: QtCore/QCalendar-hasYearZero-f.rst

    .. sip:method:: PyQt5.QtCore.QCalendar.isDateValid
        :args:
            int
            int
            int
    ...
    .. sip:method:: PyQt5.QtCore.QCalendar.isGregorian
        :returns:
            bool
        :description: QtCore/QCalendar-isGregorian-f.rst

    .. sip:method:: PyQt5.QtCore.QCalendar.isLeapYear
        :args:
            int
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtCore.QCalendar.isLunar
        :returns:
            bool
        :description: QtCore/QCalendar-isLunar-f.rst

    .. sip:method:: PyQt5.QtCore.QCalendar.isLuniSolar
        :returns:
            bool
        :description: QtCore/QCalendar-isLuniSolar-f.rst

    .. sip:method:: PyQt5.QtCore.QCalendar.isProleptic
        :returns:
            bool
        :description: QtCore/QCalendar-isProleptic-f.rst

    .. sip:method:: PyQt5.QtCore.QCalendar.isSolar
        :returns:
            bool
        :description: QtCore/QCalendar-isSolar-f.rst

    .. sip:method:: PyQt5.QtCore.QCalendar.maximumDaysInMonth
        :returns:
            int
        :description: QtCore/QCalendar-maximumDaysInMonth-f.rst

    .. sip:method:: PyQt5.QtCore.QCalendar.maximumMonthsInYear
        :returns:
            int
        :description: QtCore/QCalendar-maximumMonthsInYear-f.rst

    .. sip:method:: PyQt5.QtCore.QCalendar.minimumDaysInMonth
        :returns:
            int
        :description: QtCore/QCalendar-minimumDaysInMonth-f.rst

    .. sip:method:: PyQt5.QtCore.QCalendar.monthName
        :args:
            :sip:ref:`~PyQt5.QtCore.QLocale`
            int
            year: int = :sip:ref:`~PyQt5.QtCore.QCalendar.Unspecified`
    ...
    .. sip:method:: PyQt5.QtCore.QCalendar.monthsInYear
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtCore.QCalendar.name
        :returns:
            str
        :description: QtCore/QCalendar-name-f.rst

    .. sip:method:: PyQt5.QtCore.QCalendar.partsFromDate
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDate`, datetime.date]
        :returns:
            :sip:ref:`~PyQt5.QtCore.QCalendar.YearMonthDay`
    ...
    .. sip:method:: PyQt5.QtCore.QCalendar.standaloneMonthName
        :args:
            :sip:ref:`~PyQt5.QtCore.QLocale`
            int
            year: int = :sip:ref:`~PyQt5.QtCore.QCalendar.Unspecified`
    ...
    .. sip:method:: PyQt5.QtCore.QCalendar.standaloneWeekDayName
        :args:
            :sip:ref:`~PyQt5.QtCore.QLocale`
            int
            format: :sip:ref:`~PyQt5.QtCore.QLocale.FormatType` = :sip:ref:`~PyQt5.QtCore.QLocale.FormatType.LongFormat`
    ...
    .. sip:method:: PyQt5.QtCore.QCalendar.weekDayName
        :args:
            :sip:ref:`~PyQt5.QtCore.QLocale`
            int
            format: :sip:ref:`~PyQt5.QtCore.QLocale.FormatType` = :sip:ref:`~PyQt5.QtCore.QLocale.FormatType.LongFormat`

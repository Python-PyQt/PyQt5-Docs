...
.. sip:class:: PyQt5.QtSql.QSqlQueryModel
    :inherits: :sip:ref:`~PyQt5.QtCore.QAbstractTableModel`
    :description: QtSql/QSqlQueryModel-c.rst

    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.__init__
        :args:
            parent: :sip:ref:`~PyQt5.QtCore.QObject` = None
        :description: QtSql/QSqlQueryModel-__init__-f.rst

    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.beginInsertColumns
        :args:
    ...
    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.beginInsertRows
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            int
            int
    ...
    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.beginRemoveColumns
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            int
            int
    ...
    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.beginRemoveRows
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            int
            int
    ...
    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.beginResetModel
        :description: QtSql/QSqlQueryModel-beginResetModel-f.rst

    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.canFetchMore
        :args:
    ...
    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.clear
        :description: QtSql/QSqlQueryModel-clear-f.rst

    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.columnCount
        :args:
            parent: :sip:ref:`~PyQt5.QtCore.QModelIndex` = QModelIndex()
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.data
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
    ...
    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.endInsertColumns
        :description: QtSql/QSqlQueryModel-endInsertColumns-f.rst

    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.endInsertRows
        :description: QtSql/QSqlQueryModel-endInsertRows-f.rst

    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.endRemoveColumns
        :description: QtSql/QSqlQueryModel-endRemoveColumns-f.rst

    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.endRemoveRows
        :description: QtSql/QSqlQueryModel-endRemoveRows-f.rst

    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.endResetModel
        :description: QtSql/QSqlQueryModel-endResetModel-f.rst

    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.fetchMore
        :args:
            parent: :sip:ref:`~PyQt5.QtCore.QModelIndex` = QModelIndex()
        :description: QtSql/QSqlQueryModel-fetchMore-f.rst

    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.headerData
        :args:
            int
    ...
    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.indexInQuery
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
    ...
    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.insertColumns
        :args:
            int
            int
            parent: :sip:ref:`~PyQt5.QtCore.QModelIndex` = QModelIndex()
    ...
    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.removeColumns
        :args:
            int
            int
            parent: :sip:ref:`~PyQt5.QtCore.QModelIndex` = QModelIndex()
    ...
    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.roleNames
        :returns:
            Dict[int, :sip:ref:`~PyQt5.QtCore.QByteArray`]
        :description: QtSql/QSqlQueryModel-roleNames-f.rst

    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.rowCount
        :args:
            parent: :sip:ref:`~PyQt5.QtCore.QModelIndex` = QModelIndex()
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.setHeaderData
        :args:
            int
            :sip:ref:`~PyQt5.QtCore.Qt.Orientation`
            Any
    ...
    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.setLastError
        :args:
            :sip:ref:`~PyQt5.QtSql.QSqlError`
        :description: QtSql/QSqlQueryModel-setLastError-f.rst

    .. sip:method:: PyQt5.QtSql.QSqlQueryModel.setQuery
        :args:
            :sip:ref:`~PyQt5.QtSql.QSqlQuery`

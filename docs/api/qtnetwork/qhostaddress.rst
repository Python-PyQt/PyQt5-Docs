...
.. sip:class:: PyQt5.QtNetwork.QHostAddress
    :description: QtNetwork/QHostAddress-c.rst

    .. sip:enum:: PyQt5.QtNetwork.QHostAddress.ConversionModeFlag
        :description: QtNetwork/QHostAddress-ConversionModeFlag-e.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QHostAddress.ConversionModeFlag.ConvertLocalHost
            :description: QtNetwork/QHostAddress-ConversionModeFlag-ConvertLocalHost-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QHostAddress.ConversionModeFlag.ConvertUnspecifiedAddress
            :description: QtNetwork/QHostAddress-ConversionModeFlag-ConvertUnspecifiedAddress-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QHostAddress.ConversionModeFlag.ConvertV4CompatToIPv4
            :description: QtNetwork/QHostAddress-ConversionModeFlag-ConvertV4CompatToIPv4-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QHostAddress.ConversionModeFlag.ConvertV4MappedToIPv4
            :description: QtNetwork/QHostAddress-ConversionModeFlag-ConvertV4MappedToIPv4-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QHostAddress.ConversionModeFlag.StrictConversion
            :description: QtNetwork/QHostAddress-ConversionModeFlag-StrictConversion-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QHostAddress.ConversionModeFlag.TolerantConversion
            :description: QtNetwork/QHostAddress-ConversionModeFlag-TolerantConversion-v.rst

    .. sip:enum:: PyQt5.QtNetwork.QHostAddress.SpecialAddress
        :description: QtNetwork/QHostAddress-SpecialAddress-e.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QHostAddress.SpecialAddress.Any
            :description: QtNetwork/QHostAddress-SpecialAddress-Any-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QHostAddress.SpecialAddress.AnyIPv4
            :description: QtNetwork/QHostAddress-SpecialAddress-AnyIPv4-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QHostAddress.SpecialAddress.AnyIPv6
            :description: QtNetwork/QHostAddress-SpecialAddress-AnyIPv6-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QHostAddress.SpecialAddress.Broadcast
            :description: QtNetwork/QHostAddress-SpecialAddress-Broadcast-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QHostAddress.SpecialAddress.LocalHost
            :description: QtNetwork/QHostAddress-SpecialAddress-LocalHost-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QHostAddress.SpecialAddress.LocalHostIPv6
            :description: QtNetwork/QHostAddress-SpecialAddress-LocalHostIPv6-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QHostAddress.SpecialAddress.Null
            :description: QtNetwork/QHostAddress-SpecialAddress-Null-v.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.__init__
        :description: QtNetwork/QHostAddress-__init__-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.__init__
        :args:
            :sip:ref:`~PyQt5.QtNetwork.QHostAddress.SpecialAddress`
    ...
    .. sip:method:: PyQt5.QtNetwork.QHostAddress.clear
        :description: QtNetwork/QHostAddress-clear-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.__eq__
        :args:
            Union[:sip:ref:`~PyQt5.QtNetwork.QHostAddress`, :sip:ref:`~PyQt5.QtNetwork.QHostAddress.SpecialAddress`]
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtNetwork.QHostAddress.__hash__
        :returns:
            int
        :description: QtNetwork/QHostAddress-__hash__-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.isBroadcast
        :returns:
            bool
        :description: QtNetwork/QHostAddress-isBroadcast-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.isEqual
        :args:
            Union[:sip:ref:`~PyQt5.QtNetwork.QHostAddress`, :sip:ref:`~PyQt5.QtNetwork.QHostAddress.SpecialAddress`]
            mode: Union[:sip:ref:`~PyQt5.QtNetwork.QHostAddress.ConversionMode`, :sip:ref:`~PyQt5.QtNetwork.QHostAddress.ConversionModeFlag`] = :sip:ref:`~PyQt5.QtNetwork.QHostAddress.ConversionModeFlag.TolerantConversion`
        :returns:
            bool
        :description: QtNetwork/QHostAddress-isEqual-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.isGlobal
        :returns:
            bool
        :description: QtNetwork/QHostAddress-isGlobal-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.isInSubnet
        :args:
            Tuple[Union[:sip:ref:`~PyQt5.QtNetwork.QHostAddress`, :sip:ref:`~PyQt5.QtNetwork.QHostAddress.SpecialAddress`], int]
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtNetwork.QHostAddress.isLinkLocal
        :returns:
            bool
        :description: QtNetwork/QHostAddress-isLinkLocal-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.isLoopback
        :returns:
            bool
        :description: QtNetwork/QHostAddress-isLoopback-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.isMulticast
        :returns:
            bool
        :description: QtNetwork/QHostAddress-isMulticast-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.isNull
        :returns:
            bool
        :description: QtNetwork/QHostAddress-isNull-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.isSiteLocal
        :returns:
            bool
        :description: QtNetwork/QHostAddress-isSiteLocal-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.isUniqueLocalUnicast
        :returns:
            bool
        :description: QtNetwork/QHostAddress-isUniqueLocalUnicast-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.__ne__
        :args:
            Union[:sip:ref:`~PyQt5.QtNetwork.QHostAddress`, :sip:ref:`~PyQt5.QtNetwork.QHostAddress.SpecialAddress`]
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtNetwork.QHostAddress.parseSubnet
        :args:
            str
        :returns:
            Tuple[:sip:ref:`~PyQt5.QtNetwork.QHostAddress`, int]
        :static:
        :description: QtNetwork/QHostAddress-parseSubnet-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.protocol
        :returns:
            :sip:ref:`~PyQt5.QtNetwork.QAbstractSocket.NetworkLayerProtocol`
        :description: QtNetwork/QHostAddress-protocol-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.scopeId
        :returns:
            str
        :description: QtNetwork/QHostAddress-scopeId-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.setAddress
        :args:
            :sip:ref:`~PyQt5.QtNetwork.QHostAddress.SpecialAddress`
    ...
    .. sip:method:: PyQt5.QtNetwork.QHostAddress.setScopeId
        :args:
            str
        :description: QtNetwork/QHostAddress-setScopeId-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.swap
        :args:
            :sip:ref:`~PyQt5.QtNetwork.QHostAddress`
        :description: QtNetwork/QHostAddress-swap-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.toIPv4Address
        :returns:
            int
        :description: QtNetwork/QHostAddress-toIPv4Address-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.toIPv6Address
        :returns:
            Tuple[int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int]
        :description: QtNetwork/QHostAddress-toIPv6Address-f.rst

    .. sip:method:: PyQt5.QtNetwork.QHostAddress.toString
        :returns:
            str

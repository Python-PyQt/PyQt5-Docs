...
.. sip:class:: PyQt5.QtNetwork.QSslCertificate
    ...
    .. sip:enum:: PyQt5.QtNetwork.QSslCertificate.SubjectInfo
        ...
        .. sip:enum-member:: PyQt5.QtNetwork.QSslCertificate.SubjectInfo.CommonName
            :description: QtNetwork/QSslCertificate-SubjectInfo-CommonName-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QSslCertificate.SubjectInfo.CountryName
            :description: QtNetwork/QSslCertificate-SubjectInfo-CountryName-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QSslCertificate.SubjectInfo.DistinguishedNameQualifier
            :description: QtNetwork/QSslCertificate-SubjectInfo-DistinguishedNameQualifier-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QSslCertificate.SubjectInfo.EmailAddress
            :description: QtNetwork/QSslCertificate-SubjectInfo-EmailAddress-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QSslCertificate.SubjectInfo.LocalityName
            :description: QtNetwork/QSslCertificate-SubjectInfo-LocalityName-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QSslCertificate.SubjectInfo.Organization
            :description: QtNetwork/QSslCertificate-SubjectInfo-Organization-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QSslCertificate.SubjectInfo.OrganizationalUnitName
            :description: QtNetwork/QSslCertificate-SubjectInfo-OrganizationalUnitName-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QSslCertificate.SubjectInfo.SerialNumber
            :description: QtNetwork/QSslCertificate-SubjectInfo-SerialNumber-v.rst

        .. sip:enum-member:: PyQt5.QtNetwork.QSslCertificate.SubjectInfo.StateOrProvinceName
            :description: QtNetwork/QSslCertificate-SubjectInfo-StateOrProvinceName-v.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.__init__
        :args:
    ...
    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.__init__
        :args:
            data: Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray] = QByteArray()
            format: :sip:ref:`~PyQt5.QtNetwork.QSsl.EncodingFormat` = :sip:ref:`~PyQt5.QtNetwork.QSsl.EncodingFormat.Pem`
        :description: QtNetwork/QSslCertificate-__init__-f-2.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.clear
        :description: QtNetwork/QSslCertificate-clear-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.digest
        :args:
            algorithm: :sip:ref:`~PyQt5.QtCore.QCryptographicHash.Algorithm` = :sip:ref:`~PyQt5.QtCore.QCryptographicHash.Algorithm.Md5`
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: QtNetwork/QSslCertificate-digest-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.effectiveDate
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
        :description: QtNetwork/QSslCertificate-effectiveDate-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.__eq__
        :args:
            :sip:ref:`~PyQt5.QtNetwork.QSslCertificate`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.expiryDate
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDateTime`
        :description: QtNetwork/QSslCertificate-expiryDate-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.extensions
        :returns:
            List[:sip:ref:`~PyQt5.QtNetwork.QSslCertificateExtension`]
        :description: QtNetwork/QSslCertificate-extensions-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.fromData
        :args:
    ...
    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.fromDevice
        :args:
            :sip:ref:`~PyQt5.QtCore.QIODevice`
            format: :sip:ref:`~PyQt5.QtNetwork.QSsl.EncodingFormat` = :sip:ref:`~PyQt5.QtNetwork.QSsl.EncodingFormat.Pem`
        :returns:
    ...
    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.fromPath
        :args:
            str
            format: :sip:ref:`~PyQt5.QtNetwork.QSsl.EncodingFormat` = :sip:ref:`~PyQt5.QtNetwork.QSsl.EncodingFormat.Pem`
    ...
    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.handle
        :returns:
            sip.voidptr
        :description: QtNetwork/QSslCertificate-handle-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.__hash__
        :returns:
            int
        :description: QtNetwork/QSslCertificate-__hash__-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.importPkcs12
        :args:
            :sip:ref:`~PyQt5.QtCore.QIODevice`
            :sip:ref:`~PyQt5.QtNetwork.QSslKey`
            :sip:ref:`~PyQt5.QtNetwork.QSslCertificate`
            caCertificates: Iterable[:sip:ref:`~PyQt5.QtNetwork.QSslCertificate`] = []
    ...
    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.isBlacklisted
        :returns:
            bool
        :description: QtNetwork/QSslCertificate-isBlacklisted-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.isNull
        :returns:
            bool
        :description: QtNetwork/QSslCertificate-isNull-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.isSelfSigned
        :returns:
            bool
        :description: QtNetwork/QSslCertificate-isSelfSigned-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.issuerDisplayName
        :returns:
            str
        :description: QtNetwork/QSslCertificate-issuerDisplayName-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.issuerInfo
        :args:
            :sip:ref:`~PyQt5.QtNetwork.QSslCertificate.SubjectInfo`
        :returns:
            List[str]
    ...
    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.issuerInfoAttributes
        :returns:
            List[:sip:ref:`~PyQt5.QtCore.QByteArray`]
        :description: QtNetwork/QSslCertificate-issuerInfoAttributes-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.__ne__
        :args:
            :sip:ref:`~PyQt5.QtNetwork.QSslCertificate`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.publicKey
        :returns:
            :sip:ref:`~PyQt5.QtNetwork.QSslKey`
        :description: QtNetwork/QSslCertificate-publicKey-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.serialNumber
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: QtNetwork/QSslCertificate-serialNumber-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.subjectAlternativeNames
        :returns:
            Dict[:sip:ref:`~PyQt5.QtNetwork.QSsl.AlternativeNameEntryType`, List[str]]
        :description: QtNetwork/QSslCertificate-subjectAlternativeNames-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.subjectDisplayName
        :returns:
            str
        :description: QtNetwork/QSslCertificate-subjectDisplayName-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.subjectInfo
        :args:
            :sip:ref:`~PyQt5.QtNetwork.QSslCertificate.SubjectInfo`
        :returns:
            List[str]
    ...
    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.subjectInfoAttributes
        :returns:
            List[:sip:ref:`~PyQt5.QtCore.QByteArray`]
        :description: QtNetwork/QSslCertificate-subjectInfoAttributes-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.swap
        :args:
            :sip:ref:`~PyQt5.QtNetwork.QSslCertificate`
        :description: QtNetwork/QSslCertificate-swap-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.toDer
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: QtNetwork/QSslCertificate-toDer-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.toPem
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: QtNetwork/QSslCertificate-toPem-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.toText
        :returns:
            str
        :description: QtNetwork/QSslCertificate-toText-f.rst

    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.verify
        :args:
    ...
    .. sip:method:: PyQt5.QtNetwork.QSslCertificate.version
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`

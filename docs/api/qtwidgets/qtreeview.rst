...
.. sip:class:: PyQt5.QtWidgets.QTreeView
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.columnCountChanged
        :args:
            int
            int
        :description: QtWidgets/QTreeView-columnCountChanged-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.columnMoved
        :description: QtWidgets/QTreeView-columnMoved-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.columnResized
        :args:
            int
            int
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.columnViewportPosition
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.columnWidth
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.currentChanged
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :description: QtWidgets/QTreeView-currentChanged-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.dataChanged
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            roles: Iterable[int] = []
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.dragMoveEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QDragMoveEvent`
        :description: QtWidgets/QTreeView-dragMoveEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.drawBranches
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.drawRow
        :args:
            :sip:ref:`~PyQt5.QtGui.QPainter`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.drawTree
        :args:
            :sip:ref:`~PyQt5.QtGui.QPainter`
            :sip:ref:`~PyQt5.QtGui.QRegion`
        :description: QtWidgets/QTreeView-drawTree-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.expand
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.expandToDepth
        :args:
            int
        :description: QtWidgets/QTreeView-expandToDepth-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.header
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QHeaderView`
        :description: QtWidgets/QTreeView-header-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.hideColumn
        :args:
            int
        :description: QtWidgets/QTreeView-hideColumn-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.horizontalOffset
        :returns:
            int
        :description: QtWidgets/QTreeView-horizontalOffset-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.horizontalScrollbarAction
        :args:
            int
        :description: QtWidgets/QTreeView-horizontalScrollbarAction-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.indentation
        :returns:
            int
        :description: QtWidgets/QTreeView-indentation-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.indexAbove
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.indexAt
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.indexBelow
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.indexRowSizeHint
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.isAnimated
        :returns:
            bool
        :description: QtWidgets/QTreeView-isAnimated-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.isColumnHidden
        :args:
            int
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.isExpanded
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.isFirstColumnSpanned
        :args:
            int
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.isHeaderHidden
        :returns:
            bool
        :description: QtWidgets/QTreeView-isHeaderHidden-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.isIndexHidden
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.isRowHidden
        :args:
            int
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.paintEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QPaintEvent`
        :description: QtWidgets/QTreeView-paintEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.reexpand
        :description: QtWidgets/QTreeView-reexpand-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.reset
        :description: QtWidgets/QTreeView-reset-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.resetIndentation
        :description: QtWidgets/QTreeView-resetIndentation-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.resizeColumnToContents
        :args:
            int
        :description: QtWidgets/QTreeView-resizeColumnToContents-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.rootIsDecorated
        :returns:
            bool
        :description: QtWidgets/QTreeView-rootIsDecorated-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.rowHeight
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.rowsAboutToBeRemoved
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            int
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.rowsInserted
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            int
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.rowsRemoved
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            int
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.scrollContentsBy
        :args:
            int
            int
        :description: QtWidgets/QTreeView-scrollContentsBy-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.scrollTo
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.setHeader
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QHeaderView`
        :description: QtWidgets/QTreeView-setHeader-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.setHeaderHidden
        :args:
            bool
        :description: QtWidgets/QTreeView-setHeaderHidden-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.setIndentation
        :args:
            int
        :description: QtWidgets/QTreeView-setIndentation-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.setItemsExpandable
        :args:
            bool
        :description: QtWidgets/QTreeView-setItemsExpandable-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.setModel
        :args:
            :sip:ref:`~PyQt5.QtCore.QAbstractItemModel`
        :description: QtWidgets/QTreeView-setModel-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.setRootIndex
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :description: QtWidgets/QTreeView-setRootIndex-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.setRootIsDecorated
        :args:
            bool
        :description: QtWidgets/QTreeView-setRootIsDecorated-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.setRowHidden
        :args:
            int
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            bool
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.setSelection
        :args:
            :sip:ref:`~PyQt5.QtCore.QRect`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.setSelectionModel
        :args:
            :sip:ref:`~PyQt5.QtCore.QItemSelectionModel`
        :description: QtWidgets/QTreeView-setSelectionModel-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.setSortingEnabled
        :args:
            bool
        :description: QtWidgets/QTreeView-setSortingEnabled-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.setTreePosition
        :args:
            int
        :description: QtWidgets/QTreeView-setTreePosition-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.setUniformRowHeights
        :args:
            bool
        :description: QtWidgets/QTreeView-setUniformRowHeights-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.setWordWrap
        :args:
            bool
        :description: QtWidgets/QTreeView-setWordWrap-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.showColumn
        :args:
            int
        :description: QtWidgets/QTreeView-showColumn-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.sizeHintForColumn
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.viewportSizeHint
        :returns:
            :sip:ref:`~PyQt5.QtCore.QSize`
        :description: QtWidgets/QTreeView-viewportSizeHint-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTreeView.visualRect
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            :sip:ref:`~PyQt5.QtCore.QRect`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.visualRegionForSelection
        :args:
            :sip:ref:`~PyQt5.QtCore.QItemSelection`
        :returns:
            :sip:ref:`~PyQt5.QtGui.QRegion`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTreeView.wordWrap
        :returns:
            bool
        :description: QtWidgets/QTreeView-wordWrap-f.rst

    .. sip:signal:: PyQt5.QtWidgets.QTreeView.collapsed
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :description: QtWidgets/QTreeView-collapsed-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTreeView.expanded
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`

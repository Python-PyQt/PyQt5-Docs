...
.. sip:class:: PyQt5.QtWidgets.QDataWidgetMapper
    :inherits: :sip:ref:`~PyQt5.QtCore.QObject`
    :description: QtWidgets/QDataWidgetMapper-c.rst

    .. sip:enum:: PyQt5.QtWidgets.QDataWidgetMapper.SubmitPolicy
        :description: QtWidgets/QDataWidgetMapper-SubmitPolicy-e.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QDataWidgetMapper.SubmitPolicy.AutoSubmit
            :description: QtWidgets/QDataWidgetMapper-SubmitPolicy-AutoSubmit-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QDataWidgetMapper.SubmitPolicy.ManualSubmit
            :description: QtWidgets/QDataWidgetMapper-SubmitPolicy-ManualSubmit-v.rst

    .. sip:method:: PyQt5.QtWidgets.QDataWidgetMapper.__init__
        :args:
            parent: :sip:ref:`~PyQt5.QtCore.QObject` = None
        :description: QtWidgets/QDataWidgetMapper-__init__-f.rst

    .. sip:method:: PyQt5.QtWidgets.QDataWidgetMapper.addMapping
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QDataWidgetMapper.clearMapping
        :description: QtWidgets/QDataWidgetMapper-clearMapping-f.rst

    .. sip:method:: PyQt5.QtWidgets.QDataWidgetMapper.currentIndex
        :returns:
            int
        :description: QtWidgets/QDataWidgetMapper-currentIndex-f.rst

    .. sip:method:: PyQt5.QtWidgets.QDataWidgetMapper.itemDelegate
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QAbstractItemDelegate`
        :description: QtWidgets/QDataWidgetMapper-itemDelegate-f.rst

    .. sip:method:: PyQt5.QtWidgets.QDataWidgetMapper.mappedPropertyName
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QDataWidgetMapper.mappedSection
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QDataWidgetMapper.mappedWidgetAt
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QWidget`

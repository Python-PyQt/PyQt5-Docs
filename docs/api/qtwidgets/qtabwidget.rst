...
.. sip:class:: PyQt5.QtWidgets.QTabWidget
    ...
    .. sip:method:: PyQt5.QtWidgets.QTabWidget.changeEvent
        :args:
            :sip:ref:`~PyQt5.QtCore.QEvent`
        :description: QtWidgets/QTabWidget-changeEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.clear
        :description: QtWidgets/QTabWidget-clear-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.cornerWidget
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QTabWidget.count
        :returns:
            int
        :description: QtWidgets/QTabWidget-count-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.currentIndex
        :returns:
            int
        :description: QtWidgets/QTabWidget-currentIndex-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.currentWidget
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
        :description: QtWidgets/QTabWidget-currentWidget-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.documentMode
        :returns:
            bool
        :description: QtWidgets/QTabWidget-documentMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.elideMode
        :returns:
            :sip:ref:`~PyQt5.QtCore.Qt.TextElideMode`
        :description: QtWidgets/QTabWidget-elideMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.event
        :args:
            :sip:ref:`~PyQt5.QtCore.QEvent`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWidgets.QTabWidget.hasHeightForWidth
        :returns:
            bool
        :description: QtWidgets/QTabWidget-hasHeightForWidth-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.heightForWidth
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTabWidget.iconSize
        :returns:
            :sip:ref:`~PyQt5.QtCore.QSize`
        :description: QtWidgets/QTabWidget-iconSize-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.indexOf
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTabWidget.initStyleOption
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QStyleOptionTabWidgetFrame`
        :description: QtWidgets/QTabWidget-initStyleOption-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.insertTab
        :args:
            int
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
            str
    ...
    .. sip:method:: PyQt5.QtWidgets.QTabWidget.isMovable
        :returns:
            bool
        :description: QtWidgets/QTabWidget-isMovable-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.isTabEnabled
        :args:
            int
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWidgets.QTabWidget.setUsesScrollButtons
        :args:
            bool
        :description: QtWidgets/QTabWidget-setUsesScrollButtons-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.showEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QShowEvent`
        :description: QtWidgets/QTabWidget-showEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.sizeHint
        :returns:
            :sip:ref:`~PyQt5.QtCore.QSize`
        :description: QtWidgets/QTabWidget-sizeHint-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.tabBar
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QTabBar`
        :description: QtWidgets/QTabWidget-tabBar-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.tabBarAutoHide
        :returns:
            bool
        :description: QtWidgets/QTabWidget-tabBarAutoHide-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.tabIcon
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtGui.QIcon`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTabWidget.tabInserted
        :args:
            int
        :description: QtWidgets/QTabWidget-tabInserted-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.tabPosition
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QTabWidget.TabPosition`
        :description: QtWidgets/QTabWidget-tabPosition-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.tabRemoved
        :args:
            int
        :description: QtWidgets/QTabWidget-tabRemoved-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.tabsClosable
        :returns:
            bool
        :description: QtWidgets/QTabWidget-tabsClosable-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.tabShape
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QTabWidget.TabShape`
        :description: QtWidgets/QTabWidget-tabShape-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.tabText
        :args:
            int
        :returns:
            str
    ...
    .. sip:method:: PyQt5.QtWidgets.QTabWidget.tabToolTip
        :args:
            int
        :returns:
            str
    ...
    .. sip:method:: PyQt5.QtWidgets.QTabWidget.tabWhatsThis
        :args:
            int
        :returns:
            str
    ...
    .. sip:method:: PyQt5.QtWidgets.QTabWidget.usesScrollButtons
        :returns:
            bool
        :description: QtWidgets/QTabWidget-usesScrollButtons-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTabWidget.widget
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
    ...
    .. sip:signal:: PyQt5.QtWidgets.QTabWidget.currentChanged
        :args:
            int
        :description: QtWidgets/QTabWidget-currentChanged-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTabWidget.tabBarClicked
        :args:
            int
        :description: QtWidgets/QTabWidget-tabBarClicked-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTabWidget.tabBarDoubleClicked
        :args:
            int
        :description: QtWidgets/QTabWidget-tabBarDoubleClicked-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTabWidget.tabCloseRequested
        :args:
            int

...
.. sip:class:: PyQt5.QtWidgets.QTableWidget
    :inherits: :sip:ref:`~PyQt5.QtWidgets.QTableView`
    :description: QtWidgets/QTableWidget-c.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.__init__
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.cellWidget
        :args:
            int
            int
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.clear
        :description: QtWidgets/QTableWidget-clear-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.clearContents
        :description: QtWidgets/QTableWidget-clearContents-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.closePersistentEditor
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :description: QtWidgets/QTableWidget-closePersistentEditor-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.column
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.columnCount
        :returns:
            int
        :description: QtWidgets/QTableWidget-columnCount-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.currentColumn
        :returns:
            int
        :description: QtWidgets/QTableWidget-currentColumn-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.currentItem
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :description: QtWidgets/QTableWidget-currentItem-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.currentRow
        :returns:
            int
        :description: QtWidgets/QTableWidget-currentRow-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.dropEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QDropEvent`
        :description: QtWidgets/QTableWidget-dropEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.dropMimeData
        :args:
            int
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.editItem
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :description: QtWidgets/QTableWidget-editItem-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.event
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.findItems
        :args:
            str
            Union[:sip:ref:`~PyQt5.QtCore.Qt.MatchFlags`, :sip:ref:`~PyQt5.QtCore.Qt.MatchFlag`]
        :returns:
            List[:sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`]
        :description: QtWidgets/QTableWidget-findItems-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.horizontalHeaderItem
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.indexFromItem
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.insertColumn
        :args:
            int
        :description: QtWidgets/QTableWidget-insertColumn-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.insertRow
        :args:
            int
        :description: QtWidgets/QTableWidget-insertRow-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.isPersistentEditorOpen
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.isSortingEnabled
        :returns:
            bool
        :description: QtWidgets/QTableWidget-isSortingEnabled-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.item
        :args:
            int
            int
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.itemAt
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.itemFromIndex
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.itemPrototype
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :description: QtWidgets/QTableWidget-itemPrototype-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.items
        :args:
            :sip:ref:`~PyQt5.QtCore.QMimeData`
        :returns:
            List[:sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`]
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.mimeData
        :args:
            Iterable[:sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`]
        :returns:
            :sip:ref:`~PyQt5.QtCore.QMimeData`
        :description: QtWidgets/QTableWidget-mimeData-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.mimeTypes
        :returns:
            List[str]
        :description: QtWidgets/QTableWidget-mimeTypes-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.openPersistentEditor
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :description: QtWidgets/QTableWidget-openPersistentEditor-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.removeCellWidget
        :args:
            int
            int
        :description: QtWidgets/QTableWidget-removeCellWidget-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.removeColumn
        :args:
            int
        :description: QtWidgets/QTableWidget-removeColumn-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.removeRow
        :args:
            int
        :description: QtWidgets/QTableWidget-removeRow-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.row
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.rowCount
        :returns:
            int
        :description: QtWidgets/QTableWidget-rowCount-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.scrollToItem
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.selectedItems
        :returns:
            List[:sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`]
        :description: QtWidgets/QTableWidget-selectedItems-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.selectedRanges
        :returns:
            List[:sip:ref:`~PyQt5.QtWidgets.QTableWidgetSelectionRange`]
        :description: QtWidgets/QTableWidget-selectedRanges-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.setCellWidget
        :args:
            int
            int
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.setColumnCount
        :args:
            int
        :description: QtWidgets/QTableWidget-setColumnCount-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.setCurrentCell
        :args:
            int
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.setCurrentItem
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.setHorizontalHeaderItem
        :args:
            int
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :description: QtWidgets/QTableWidget-setHorizontalHeaderItem-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.setHorizontalHeaderLabels
        :args:
            Iterable[str]
        :description: QtWidgets/QTableWidget-setHorizontalHeaderLabels-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.setItem
        :args:
            int
            int
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.setItemPrototype
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :description: QtWidgets/QTableWidget-setItemPrototype-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.setRangeSelected
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetSelectionRange`
            bool
        :description: QtWidgets/QTableWidget-setRangeSelected-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.setRowCount
        :args:
            int
        :description: QtWidgets/QTableWidget-setRowCount-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.setSortingEnabled
        :args:
            bool
        :description: QtWidgets/QTableWidget-setSortingEnabled-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.setVerticalHeaderItem
        :args:
            int
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :description: QtWidgets/QTableWidget-setVerticalHeaderItem-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.setVerticalHeaderLabels
        :args:
            Iterable[str]
        :description: QtWidgets/QTableWidget-setVerticalHeaderLabels-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.sortItems
        :args:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.supportedDropActions
        :returns:
            :sip:ref:`~PyQt5.QtCore.Qt.DropActions`
        :description: QtWidgets/QTableWidget-supportedDropActions-f.rst

    .. sip:method:: PyQt5.QtWidgets.QTableWidget.takeHorizontalHeaderItem
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.takeItem
        :args:
            int
            int
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.takeVerticalHeaderItem
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.verticalHeaderItem
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.visualColumn
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.visualItemRect
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QTableWidget.visualRow
        :args:
            int
        :returns:
            int
    ...
    .. sip:signal:: PyQt5.QtWidgets.QTableWidget.cellActivated
        :args:
            int
            int
        :description: QtWidgets/QTableWidget-cellActivated-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTableWidget.cellChanged
        :args:
            int
            int
        :description: QtWidgets/QTableWidget-cellChanged-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTableWidget.cellClicked
        :args:
            int
            int
        :description: QtWidgets/QTableWidget-cellClicked-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTableWidget.cellDoubleClicked
        :args:
            int
            int
        :description: QtWidgets/QTableWidget-cellDoubleClicked-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTableWidget.cellEntered
        :args:
            int
            int
        :description: QtWidgets/QTableWidget-cellEntered-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTableWidget.cellPressed
        :args:
            int
            int
        :description: QtWidgets/QTableWidget-cellPressed-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTableWidget.currentCellChanged
        :args:
            int
            int
            int
    ...
    .. sip:signal:: PyQt5.QtWidgets.QTableWidget.currentItemChanged
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :description: QtWidgets/QTableWidget-currentItemChanged-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTableWidget.itemActivated
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :description: QtWidgets/QTableWidget-itemActivated-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTableWidget.itemChanged
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :description: QtWidgets/QTableWidget-itemChanged-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTableWidget.itemClicked
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :description: QtWidgets/QTableWidget-itemClicked-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTableWidget.itemDoubleClicked
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :description: QtWidgets/QTableWidget-itemDoubleClicked-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTableWidget.itemEntered
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :description: QtWidgets/QTableWidget-itemEntered-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTableWidget.itemPressed
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QTableWidgetItem`
        :description: QtWidgets/QTableWidget-itemPressed-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QTableWidget.itemSelectionChanged

...
.. sip:class:: PyQt5.QtWidgets.QListView
    ...
    .. sip:method:: PyQt5.QtWidgets.QListView.flow
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QListView.Flow`
        :description: QtWidgets/QListView-flow-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.gridSize
        :returns:
            :sip:ref:`~PyQt5.QtCore.QSize`
        :description: QtWidgets/QListView-gridSize-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.horizontalOffset
        :returns:
            int
        :description: QtWidgets/QListView-horizontalOffset-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.indexAt
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QListView.isIndexHidden
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWidgets.QListView.isRowHidden
        :args:
            int
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWidgets.QListView.isSelectionRectVisible
        :returns:
            bool
        :description: QtWidgets/QListView-isSelectionRectVisible-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.isWrapping
        :returns:
            bool
        :description: QtWidgets/QListView-isWrapping-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.itemAlignment
        :returns:
            :sip:ref:`~PyQt5.QtCore.Qt.Alignment`
        :description: QtWidgets/QListView-itemAlignment-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.layoutMode
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QListView.LayoutMode`
        :description: QtWidgets/QListView-layoutMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.modelColumn
        :returns:
            int
        :description: QtWidgets/QListView-modelColumn-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.mouseMoveEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QMouseEvent`
        :description: QtWidgets/QListView-mouseMoveEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.mouseReleaseEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QMouseEvent`
        :description: QtWidgets/QListView-mouseReleaseEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.moveCursor
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QListView.movement
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QListView.Movement`
        :description: QtWidgets/QListView-movement-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.paintEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QPaintEvent`
        :description: QtWidgets/QListView-paintEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.rectForIndex
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QListView.reset
        :description: QtWidgets/QListView-reset-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.resizeEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QResizeEvent`
        :description: QtWidgets/QListView-resizeEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.resizeMode
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QListView.ResizeMode`
        :description: QtWidgets/QListView-resizeMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.rowsAboutToBeRemoved
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            int
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QListView.rowsInserted
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            int
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QListView.scrollContentsBy
        :args:
            int
            int
        :description: QtWidgets/QListView-scrollContentsBy-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.scrollTo
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
    ...
    .. sip:method:: PyQt5.QtWidgets.QListView.setLayoutMode
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QListView.LayoutMode`
        :description: QtWidgets/QListView-setLayoutMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.setModelColumn
        :args:
            int
        :description: QtWidgets/QListView-setModelColumn-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.setMovement
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QListView.Movement`
        :description: QtWidgets/QListView-setMovement-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.setPositionForIndex
        :args:
            :sip:ref:`~PyQt5.QtCore.QPoint`
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :description: QtWidgets/QListView-setPositionForIndex-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.setResizeMode
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QListView.ResizeMode`
        :description: QtWidgets/QListView-setResizeMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.setRootIndex
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :description: QtWidgets/QListView-setRootIndex-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.setRowHidden
        :args:
            int
            bool
        :description: QtWidgets/QListView-setRowHidden-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.setSelection
        :args:
            :sip:ref:`~PyQt5.QtCore.QRect`
    ...
    .. sip:method:: PyQt5.QtWidgets.QListView.setSelectionRectVisible
        :args:
            bool
        :description: QtWidgets/QListView-setSelectionRectVisible-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.setSpacing
        :args:
            int
        :description: QtWidgets/QListView-setSpacing-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.setUniformItemSizes
        :args:
            bool
        :description: QtWidgets/QListView-setUniformItemSizes-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.setViewMode
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QListView.ViewMode`
        :description: QtWidgets/QListView-setViewMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.setWordWrap
        :args:
            bool
        :description: QtWidgets/QListView-setWordWrap-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.setWrapping
        :args:
            bool
        :description: QtWidgets/QListView-setWrapping-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.spacing
        :returns:
            int
        :description: QtWidgets/QListView-spacing-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.startDrag
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QListView.timerEvent
        :args:
            :sip:ref:`~PyQt5.QtCore.QTimerEvent`
        :description: QtWidgets/QListView-timerEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.uniformItemSizes
        :returns:
            bool
        :description: QtWidgets/QListView-uniformItemSizes-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.updateGeometries
        :description: QtWidgets/QListView-updateGeometries-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.verticalOffset
        :returns:
            int
        :description: QtWidgets/QListView-verticalOffset-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.viewMode
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QListView.ViewMode`
        :description: QtWidgets/QListView-viewMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.viewOptions
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QStyleOptionViewItem`
        :description: QtWidgets/QListView-viewOptions-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.viewportSizeHint
        :returns:
            :sip:ref:`~PyQt5.QtCore.QSize`
        :description: QtWidgets/QListView-viewportSizeHint-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.visualRect
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            :sip:ref:`~PyQt5.QtCore.QRect`
    ...
    .. sip:method:: PyQt5.QtWidgets.QListView.visualRegionForSelection
        :args:
            :sip:ref:`~PyQt5.QtCore.QItemSelection`
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QListView.wheelEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QWheelEvent`
        :description: QtWidgets/QListView-wheelEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QListView.wordWrap
        :returns:
            bool
        :description: QtWidgets/QListView-wordWrap-f.rst

    .. sip:signal:: PyQt5.QtWidgets.QListView.indexesMoved
        :args:

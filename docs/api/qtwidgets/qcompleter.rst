...
.. sip:class:: PyQt5.QtWidgets.QCompleter
    :inherits: :sip:ref:`~PyQt5.QtCore.QObject`
    :description: QtWidgets/QCompleter-c.rst

    .. sip:enum:: PyQt5.QtWidgets.QCompleter.CompletionMode
        :description: QtWidgets/QCompleter-CompletionMode-e.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QCompleter.CompletionMode.InlineCompletion
            :description: QtWidgets/QCompleter-CompletionMode-InlineCompletion-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QCompleter.CompletionMode.PopupCompletion
            :description: QtWidgets/QCompleter-CompletionMode-PopupCompletion-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QCompleter.CompletionMode.UnfilteredPopupCompletion
            :description: QtWidgets/QCompleter-CompletionMode-UnfilteredPopupCompletion-v.rst

    .. sip:enum:: PyQt5.QtWidgets.QCompleter.ModelSorting
        :description: QtWidgets/QCompleter-ModelSorting-e.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QCompleter.ModelSorting.CaseInsensitivelySortedModel
            :description: QtWidgets/QCompleter-ModelSorting-CaseInsensitivelySortedModel-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QCompleter.ModelSorting.CaseSensitivelySortedModel
            :description: QtWidgets/QCompleter-ModelSorting-CaseSensitivelySortedModel-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QCompleter.ModelSorting.UnsortedModel
            :description: QtWidgets/QCompleter-ModelSorting-UnsortedModel-v.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.__init__
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QCompleter.eventFilter
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QCompleter.filterMode
        :returns:
            :sip:ref:`~PyQt5.QtCore.Qt.MatchFlags`
        :description: QtWidgets/QCompleter-filterMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.maxVisibleItems
        :returns:
            int
        :description: QtWidgets/QCompleter-maxVisibleItems-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.model
        :returns:
            :sip:ref:`~PyQt5.QtCore.QAbstractItemModel`
        :description: QtWidgets/QCompleter-model-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.modelSorting
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QCompleter.ModelSorting`
        :description: QtWidgets/QCompleter-modelSorting-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.pathFromIndex
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            str
    ...
    .. sip:method:: PyQt5.QtWidgets.QCompleter.popup
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QAbstractItemView`
        :description: QtWidgets/QCompleter-popup-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.setCaseSensitivity
        :args:
            :sip:ref:`~PyQt5.QtCore.Qt.CaseSensitivity`
        :description: QtWidgets/QCompleter-setCaseSensitivity-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.setCompletionColumn
        :args:
            int
        :description: QtWidgets/QCompleter-setCompletionColumn-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.setCompletionMode
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QCompleter.CompletionMode`
        :description: QtWidgets/QCompleter-setCompletionMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.setCompletionPrefix
        :args:
            str
        :description: QtWidgets/QCompleter-setCompletionPrefix-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.setCompletionRole
        :args:
            int
        :description: QtWidgets/QCompleter-setCompletionRole-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.setCurrentRow
        :args:
            int
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWidgets.QCompleter.setFilterMode
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QCompleter.setMaxVisibleItems
        :args:
            int
        :description: QtWidgets/QCompleter-setMaxVisibleItems-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.setModel
        :args:
            :sip:ref:`~PyQt5.QtCore.QAbstractItemModel`
        :description: QtWidgets/QCompleter-setModel-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.setModelSorting
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QCompleter.ModelSorting`
        :description: QtWidgets/QCompleter-setModelSorting-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.setPopup
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QAbstractItemView`
        :description: QtWidgets/QCompleter-setPopup-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.setWidget
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
        :description: QtWidgets/QCompleter-setWidget-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.setWrapAround
        :args:
            bool
        :description: QtWidgets/QCompleter-setWrapAround-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.splitPath
        :args:
            str
        :returns:
            List[str]
    ...
    .. sip:method:: PyQt5.QtWidgets.QCompleter.widget
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
        :description: QtWidgets/QCompleter-widget-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCompleter.wrapAround
        :returns:
            bool
        :description: QtWidgets/QCompleter-wrapAround-f.rst

    .. sip:signal:: PyQt5.QtWidgets.QCompleter.activated
        :args:
            str
    ...
    .. sip:signal:: PyQt5.QtWidgets.QCompleter.highlighted
        :args:
            str

...
.. sip:class:: PyQt5.QtWidgets.QCalendarWidget
    :inherits: :sip:ref:`~PyQt5.QtWidgets.QWidget`
    :description: QtWidgets/QCalendarWidget-c.rst

    .. sip:enum:: PyQt5.QtWidgets.QCalendarWidget.HorizontalHeaderFormat
        :description: QtWidgets/QCalendarWidget-HorizontalHeaderFormat-e.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QCalendarWidget.HorizontalHeaderFormat.LongDayNames
            :description: QtWidgets/QCalendarWidget-HorizontalHeaderFormat-LongDayNames-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QCalendarWidget.HorizontalHeaderFormat.NoHorizontalHeader
            :description: QtWidgets/QCalendarWidget-HorizontalHeaderFormat-NoHorizontalHeader-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QCalendarWidget.HorizontalHeaderFormat.ShortDayNames
            :description: QtWidgets/QCalendarWidget-HorizontalHeaderFormat-ShortDayNames-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QCalendarWidget.HorizontalHeaderFormat.SingleLetterDayNames
            :description: QtWidgets/QCalendarWidget-HorizontalHeaderFormat-SingleLetterDayNames-v.rst

    .. sip:enum:: PyQt5.QtWidgets.QCalendarWidget.SelectionMode
        :description: QtWidgets/QCalendarWidget-SelectionMode-e.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QCalendarWidget.SelectionMode.NoSelection
            :description: QtWidgets/QCalendarWidget-SelectionMode-NoSelection-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QCalendarWidget.SelectionMode.SingleSelection
            :description: QtWidgets/QCalendarWidget-SelectionMode-SingleSelection-v.rst

    .. sip:enum:: PyQt5.QtWidgets.QCalendarWidget.VerticalHeaderFormat
        :description: QtWidgets/QCalendarWidget-VerticalHeaderFormat-e.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QCalendarWidget.VerticalHeaderFormat.ISOWeekNumbers
            :description: QtWidgets/QCalendarWidget-VerticalHeaderFormat-ISOWeekNumbers-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QCalendarWidget.VerticalHeaderFormat.NoVerticalHeader
            :description: QtWidgets/QCalendarWidget-VerticalHeaderFormat-NoVerticalHeader-v.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.__init__
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.dateTextFormat
        :returns:
            Dict[:sip:ref:`~PyQt5.QtCore.QDate`, :sip:ref:`~PyQt5.QtGui.QTextCharFormat`]
    ...
    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.event
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.eventFilter
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.resizeEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QResizeEvent`
        :description: QtWidgets/QCalendarWidget-resizeEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.selectedDate
        :returns:
            :sip:ref:`~PyQt5.QtCore.QDate`
        :description: QtWidgets/QCalendarWidget-selectedDate-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.selectionMode
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.setDateEditAcceptDelay
        :args:
            int
        :description: QtWidgets/QCalendarWidget-setDateEditAcceptDelay-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.setDateEditEnabled
        :args:
            bool
        :description: QtWidgets/QCalendarWidget-setDateEditEnabled-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.setDateRange
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDate`, datetime.date]
            Union[:sip:ref:`~PyQt5.QtCore.QDate`, datetime.date]
        :description: QtWidgets/QCalendarWidget-setDateRange-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.setDateTextFormat
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDate`, datetime.date]
            :sip:ref:`~PyQt5.QtGui.QTextCharFormat`
        :description: QtWidgets/QCalendarWidget-setDateTextFormat-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.setFirstDayOfWeek
        :args:
            :sip:ref:`~PyQt5.QtCore.Qt.DayOfWeek`
        :description: QtWidgets/QCalendarWidget-setFirstDayOfWeek-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.setGridVisible
        :args:
            bool
        :description: QtWidgets/QCalendarWidget-setGridVisible-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.setHeaderTextFormat
        :args:
            :sip:ref:`~PyQt5.QtGui.QTextCharFormat`
        :description: QtWidgets/QCalendarWidget-setHeaderTextFormat-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.setHorizontalHeaderFormat
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QCalendarWidget.HorizontalHeaderFormat`
        :description: QtWidgets/QCalendarWidget-setHorizontalHeaderFormat-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.setMaximumDate
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDate`, datetime.date]
        :description: QtWidgets/QCalendarWidget-setMaximumDate-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.setMinimumDate
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDate`, datetime.date]
        :description: QtWidgets/QCalendarWidget-setMinimumDate-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.setNavigationBarVisible
        :args:
            bool
        :description: QtWidgets/QCalendarWidget-setNavigationBarVisible-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.setSelectedDate
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDate`, datetime.date]
        :description: QtWidgets/QCalendarWidget-setSelectedDate-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.setSelectionMode
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QCalendarWidget.SelectionMode`
        :description: QtWidgets/QCalendarWidget-setSelectionMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.setVerticalHeaderFormat
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QCalendarWidget.VerticalHeaderFormat`
        :description: QtWidgets/QCalendarWidget-setVerticalHeaderFormat-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.setWeekdayTextFormat
        :args:
            :sip:ref:`~PyQt5.QtCore.Qt.DayOfWeek`
            :sip:ref:`~PyQt5.QtGui.QTextCharFormat`
        :description: QtWidgets/QCalendarWidget-setWeekdayTextFormat-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.showNextMonth
        :description: QtWidgets/QCalendarWidget-showNextMonth-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.showNextYear
        :description: QtWidgets/QCalendarWidget-showNextYear-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.showPreviousMonth
        :description: QtWidgets/QCalendarWidget-showPreviousMonth-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.showPreviousYear
        :description: QtWidgets/QCalendarWidget-showPreviousYear-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.showSelectedDate
        :description: QtWidgets/QCalendarWidget-showSelectedDate-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.showToday
        :description: QtWidgets/QCalendarWidget-showToday-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.sizeHint
        :returns:
            :sip:ref:`~PyQt5.QtCore.QSize`
        :description: QtWidgets/QCalendarWidget-sizeHint-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.updateCell
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDate`, datetime.date]
        :description: QtWidgets/QCalendarWidget-updateCell-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.updateCells
        :description: QtWidgets/QCalendarWidget-updateCells-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.verticalHeaderFormat
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QCalendarWidget.VerticalHeaderFormat`
        :description: QtWidgets/QCalendarWidget-verticalHeaderFormat-f.rst

    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.weekdayTextFormat
        :args:
            :sip:ref:`~PyQt5.QtCore.Qt.DayOfWeek`
        :returns:
            :sip:ref:`~PyQt5.QtGui.QTextCharFormat`
    ...
    .. sip:method:: PyQt5.QtWidgets.QCalendarWidget.yearShown
        :returns:
            int
        :description: QtWidgets/QCalendarWidget-yearShown-f.rst

    .. sip:signal:: PyQt5.QtWidgets.QCalendarWidget.activated
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDate`, datetime.date]
        :description: QtWidgets/QCalendarWidget-activated-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QCalendarWidget.clicked
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QDate`, datetime.date]
        :description: QtWidgets/QCalendarWidget-clicked-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QCalendarWidget.currentPageChanged
        :args:
            int
            int
        :description: QtWidgets/QCalendarWidget-currentPageChanged-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QCalendarWidget.selectionChanged

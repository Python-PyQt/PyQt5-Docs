...
.. sip:class:: PyQt5.QtWidgets.QLineEdit
    :inherits: :sip:ref:`~PyQt5.QtWidgets.QWidget`
    :description: QtWidgets/QLineEdit-c.rst

    .. sip:enum:: PyQt5.QtWidgets.QLineEdit.ActionPosition
        :description: QtWidgets/QLineEdit-ActionPosition-e.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QLineEdit.ActionPosition.LeadingPosition
            :description: QtWidgets/QLineEdit-ActionPosition-LeadingPosition-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QLineEdit.ActionPosition.TrailingPosition
            :description: QtWidgets/QLineEdit-ActionPosition-TrailingPosition-v.rst

    .. sip:enum:: PyQt5.QtWidgets.QLineEdit.EchoMode
        :description: QtWidgets/QLineEdit-EchoMode-e.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QLineEdit.EchoMode.NoEcho
            :description: QtWidgets/QLineEdit-EchoMode-NoEcho-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QLineEdit.EchoMode.Normal
            :description: QtWidgets/QLineEdit-EchoMode-Normal-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QLineEdit.EchoMode.Password
            :description: QtWidgets/QLineEdit-EchoMode-Password-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QLineEdit.EchoMode.PasswordEchoOnEdit
            :description: QtWidgets/QLineEdit-EchoMode-PasswordEchoOnEdit-v.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.__init__
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QLineEdit.addAction
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QLineEdit.addAction
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QAction`
            :sip:ref:`~PyQt5.QtWidgets.QLineEdit.ActionPosition`
    ...
    .. sip:method:: PyQt5.QtWidgets.QLineEdit.focusInEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QFocusEvent`
        :description: QtWidgets/QLineEdit-focusInEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.focusOutEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QFocusEvent`
        :description: QtWidgets/QLineEdit-focusOutEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.getTextMargins
        :returns:
            int
            int
            int
            int
        :description: QtWidgets/QLineEdit-getTextMargins-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.hasAcceptableInput
        :returns:
            bool
        :description: QtWidgets/QLineEdit-hasAcceptableInput-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.hasFrame
        :returns:
            bool
        :description: QtWidgets/QLineEdit-hasFrame-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.hasSelectedText
        :returns:
            bool
        :description: QtWidgets/QLineEdit-hasSelectedText-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.home
        :args:
            bool
        :description: QtWidgets/QLineEdit-home-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.initStyleOption
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QStyleOptionFrame`
        :description: QtWidgets/QLineEdit-initStyleOption-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.inputMask
        :returns:
            str
        :description: QtWidgets/QLineEdit-inputMask-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.inputMethodEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QInputMethodEvent`
        :description: QtWidgets/QLineEdit-inputMethodEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.inputMethodQuery
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setClearButtonEnabled
        :args:
            bool
        :description: QtWidgets/QLineEdit-setClearButtonEnabled-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setCompleter
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QCompleter`
        :description: QtWidgets/QLineEdit-setCompleter-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setCursorMoveStyle
        :args:
            :sip:ref:`~PyQt5.QtCore.Qt.CursorMoveStyle`
        :description: QtWidgets/QLineEdit-setCursorMoveStyle-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setCursorPosition
        :args:
            int
        :description: QtWidgets/QLineEdit-setCursorPosition-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setDragEnabled
        :args:
            bool
        :description: QtWidgets/QLineEdit-setDragEnabled-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setEchoMode
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QLineEdit.EchoMode`
        :description: QtWidgets/QLineEdit-setEchoMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setFrame
        :args:
            bool
        :description: QtWidgets/QLineEdit-setFrame-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setInputMask
        :args:
            str
        :description: QtWidgets/QLineEdit-setInputMask-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setMaxLength
        :args:
            int
        :description: QtWidgets/QLineEdit-setMaxLength-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setModified
        :args:
            bool
        :description: QtWidgets/QLineEdit-setModified-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setPlaceholderText
        :args:
            str
        :description: QtWidgets/QLineEdit-setPlaceholderText-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setReadOnly
        :args:
            bool
        :description: QtWidgets/QLineEdit-setReadOnly-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setSelection
        :args:
            int
            int
        :description: QtWidgets/QLineEdit-setSelection-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setText
        :args:
            str
        :description: QtWidgets/QLineEdit-setText-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setTextMargins
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QLineEdit.setValidator
        :args:
            :sip:ref:`~PyQt5.QtGui.QValidator`
        :description: QtWidgets/QLineEdit-setValidator-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.sizeHint
        :returns:
            :sip:ref:`~PyQt5.QtCore.QSize`
        :description: QtWidgets/QLineEdit-sizeHint-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.text
        :returns:
            str
        :description: QtWidgets/QLineEdit-text-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.textMargins
        :returns:
            :sip:ref:`~PyQt5.QtCore.QMargins`
        :description: QtWidgets/QLineEdit-textMargins-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.undo
        :description: QtWidgets/QLineEdit-undo-f.rst

    .. sip:method:: PyQt5.QtWidgets.QLineEdit.validator
        :returns:
            :sip:ref:`~PyQt5.QtGui.QValidator`
        :description: QtWidgets/QLineEdit-validator-f.rst

    .. sip:signal:: PyQt5.QtWidgets.QLineEdit.cursorPositionChanged
        :args:
            int
            int
        :description: QtWidgets/QLineEdit-cursorPositionChanged-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QLineEdit.editingFinished
        :description: QtWidgets/QLineEdit-editingFinished-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QLineEdit.inputRejected
        :description: QtWidgets/QLineEdit-inputRejected-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QLineEdit.returnPressed
        :description: QtWidgets/QLineEdit-returnPressed-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QLineEdit.selectionChanged
        :description: QtWidgets/QLineEdit-selectionChanged-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QLineEdit.textChanged
        :args:
            str
        :description: QtWidgets/QLineEdit-textChanged-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QLineEdit.textEdited
        :args:
            str

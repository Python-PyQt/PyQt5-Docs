...
.. sip:class:: PyQt5.QtWidgets.QHeaderView
    :inherits: :sip:ref:`~PyQt5.QtWidgets.QAbstractItemView`
    :description: QtWidgets/QHeaderView-c.rst

    .. sip:enum:: PyQt5.QtWidgets.QHeaderView.ResizeMode
        :description: QtWidgets/QHeaderView-ResizeMode-e.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QHeaderView.ResizeMode.Custom
            :description: QtWidgets/QHeaderView-ResizeMode-Custom-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QHeaderView.ResizeMode.Fixed
            :description: QtWidgets/QHeaderView-ResizeMode-Fixed-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QHeaderView.ResizeMode.Interactive
            :description: QtWidgets/QHeaderView-ResizeMode-Interactive-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QHeaderView.ResizeMode.ResizeToContents
            :description: QtWidgets/QHeaderView-ResizeMode-ResizeToContents-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QHeaderView.ResizeMode.Stretch
            :description: QtWidgets/QHeaderView-ResizeMode-Stretch-v.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.__init__
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.cascadingSectionResizes
        :returns:
            bool
        :description: QtWidgets/QHeaderView-cascadingSectionResizes-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.count
        :returns:
            int
        :description: QtWidgets/QHeaderView-count-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.currentChanged
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :description: QtWidgets/QHeaderView-currentChanged-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.dataChanged
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            roles: Iterable[int] = []
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.defaultAlignment
        :returns:
            :sip:ref:`~PyQt5.QtCore.Qt.Alignment`
        :description: QtWidgets/QHeaderView-defaultAlignment-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.defaultSectionSize
        :returns:
            int
        :description: QtWidgets/QHeaderView-defaultSectionSize-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.event
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.headerDataChanged
        :args:
            :sip:ref:`~PyQt5.QtCore.Qt.Orientation`
            int
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.hiddenSectionCount
        :returns:
            int
        :description: QtWidgets/QHeaderView-hiddenSectionCount-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.hideSection
        :args:
            int
        :description: QtWidgets/QHeaderView-hideSection-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.highlightSections
        :returns:
            bool
        :description: QtWidgets/QHeaderView-highlightSections-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.horizontalOffset
        :returns:
            int
        :description: QtWidgets/QHeaderView-horizontalOffset-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.indexAt
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.initialize
        :description: QtWidgets/QHeaderView-initialize-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.initializeSections
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.initStyleOption
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QStyleOptionHeader`
        :description: QtWidgets/QHeaderView-initStyleOption-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.isFirstSectionMovable
        :returns:
            bool
        :description: QtWidgets/QHeaderView-isFirstSectionMovable-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.isIndexHidden
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.isSectionHidden
        :args:
            int
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.isSortIndicatorShown
        :returns:
            bool
        :description: QtWidgets/QHeaderView-isSortIndicatorShown-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.__len__
        :returns:
            int
        :description: QtWidgets/QHeaderView-__len__-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.length
        :returns:
            int
        :description: QtWidgets/QHeaderView-length-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.logicalIndex
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.logicalIndexAt
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.maximumSectionSize
        :returns:
            int
        :description: QtWidgets/QHeaderView-maximumSectionSize-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.minimumSectionSize
        :returns:
            int
        :description: QtWidgets/QHeaderView-minimumSectionSize-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.mouseDoubleClickEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QMouseEvent`
        :description: QtWidgets/QHeaderView-mouseDoubleClickEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.mouseMoveEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QMouseEvent`
        :description: QtWidgets/QHeaderView-mouseMoveEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.mousePressEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QMouseEvent`
        :description: QtWidgets/QHeaderView-mousePressEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.mouseReleaseEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QMouseEvent`
        :description: QtWidgets/QHeaderView-mouseReleaseEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.moveCursor
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.moveSection
        :args:
            int
            int
        :description: QtWidgets/QHeaderView-moveSection-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.offset
        :returns:
            int
        :description: QtWidgets/QHeaderView-offset-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.orientation
        :returns:
            :sip:ref:`~PyQt5.QtCore.Qt.Orientation`
        :description: QtWidgets/QHeaderView-orientation-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.paintEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QPaintEvent`
        :description: QtWidgets/QHeaderView-paintEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.paintSection
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.reset
        :description: QtWidgets/QHeaderView-reset-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.resetDefaultSectionSize
        :description: QtWidgets/QHeaderView-resetDefaultSectionSize-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.resizeContentsPrecision
        :returns:
            int
        :description: QtWidgets/QHeaderView-resizeContentsPrecision-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.resizeSection
        :args:
            int
            int
        :description: QtWidgets/QHeaderView-resizeSection-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.resizeSections
        :description: QtWidgets/QHeaderView-resizeSections-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.resizeSections
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QHeaderView.ResizeMode`
        :description: QtWidgets/QHeaderView-resizeSections-f-1.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.restoreState
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.rowsInserted
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            int
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.saveState
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: QtWidgets/QHeaderView-saveState-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.scrollContentsBy
        :args:
            int
            int
        :description: QtWidgets/QHeaderView-scrollContentsBy-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.scrollTo
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            :sip:ref:`~PyQt5.QtWidgets.QAbstractItemView.ScrollHint`
        :description: QtWidgets/QHeaderView-scrollTo-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.sectionPosition
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.sectionResizeMode
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QHeaderView.ResizeMode`
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.sectionsAboutToBeRemoved
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            int
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.sectionsClickable
        :returns:
            bool
        :description: QtWidgets/QHeaderView-sectionsClickable-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.sectionsHidden
        :returns:
            bool
        :description: QtWidgets/QHeaderView-sectionsHidden-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.sectionsInserted
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            int
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.sectionSize
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.sectionSizeFromContents
        :args:
            int
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.sectionSizeHint
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.sectionsMovable
        :returns:
            bool
        :description: QtWidgets/QHeaderView-sectionsMovable-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.sectionsMoved
        :returns:
            bool
        :description: QtWidgets/QHeaderView-sectionsMoved-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.sectionViewportPosition
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setCascadingSectionResizes
        :args:
            bool
        :description: QtWidgets/QHeaderView-setCascadingSectionResizes-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setDefaultAlignment
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setDefaultSectionSize
        :args:
            int
        :description: QtWidgets/QHeaderView-setDefaultSectionSize-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setFirstSectionMovable
        :args:
            bool
        :description: QtWidgets/QHeaderView-setFirstSectionMovable-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setHighlightSections
        :args:
            bool
        :description: QtWidgets/QHeaderView-setHighlightSections-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setMaximumSectionSize
        :args:
            int
        :description: QtWidgets/QHeaderView-setMaximumSectionSize-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setMinimumSectionSize
        :args:
            int
        :description: QtWidgets/QHeaderView-setMinimumSectionSize-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setModel
        :args:
            :sip:ref:`~PyQt5.QtCore.QAbstractItemModel`
        :description: QtWidgets/QHeaderView-setModel-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setOffset
        :args:
            int
        :description: QtWidgets/QHeaderView-setOffset-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setOffsetToLastSection
        :description: QtWidgets/QHeaderView-setOffsetToLastSection-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setOffsetToSectionPosition
        :args:
            int
        :description: QtWidgets/QHeaderView-setOffsetToSectionPosition-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setResizeContentsPrecision
        :args:
            int
        :description: QtWidgets/QHeaderView-setResizeContentsPrecision-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setSectionHidden
        :args:
            int
            bool
        :description: QtWidgets/QHeaderView-setSectionHidden-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setSectionResizeMode
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QHeaderView.ResizeMode`
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setSectionsClickable
        :args:
            bool
        :description: QtWidgets/QHeaderView-setSectionsClickable-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setSectionsMovable
        :args:
            bool
        :description: QtWidgets/QHeaderView-setSectionsMovable-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setSelection
        :args:
            :sip:ref:`~PyQt5.QtCore.QRect`
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setSortIndicator
        :args:
            int
            :sip:ref:`~PyQt5.QtCore.Qt.SortOrder`
        :description: QtWidgets/QHeaderView-setSortIndicator-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setSortIndicatorShown
        :args:
            bool
        :description: QtWidgets/QHeaderView-setSortIndicatorShown-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setStretchLastSection
        :args:
            bool
        :description: QtWidgets/QHeaderView-setStretchLastSection-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.setVisible
        :args:
            bool
        :description: QtWidgets/QHeaderView-setVisible-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.showSection
        :args:
            int
        :description: QtWidgets/QHeaderView-showSection-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.sizeHint
        :returns:
            :sip:ref:`~PyQt5.QtCore.QSize`
        :description: QtWidgets/QHeaderView-sizeHint-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.sortIndicatorOrder
        :returns:
            :sip:ref:`~PyQt5.QtCore.Qt.SortOrder`
        :description: QtWidgets/QHeaderView-sortIndicatorOrder-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.sortIndicatorSection
        :returns:
            int
        :description: QtWidgets/QHeaderView-sortIndicatorSection-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.stretchLastSection
        :returns:
            bool
        :description: QtWidgets/QHeaderView-stretchLastSection-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.stretchSectionCount
        :returns:
            int
        :description: QtWidgets/QHeaderView-stretchSectionCount-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.swapSections
        :args:
            int
            int
        :description: QtWidgets/QHeaderView-swapSections-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.updateGeometries
        :description: QtWidgets/QHeaderView-updateGeometries-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.updateSection
        :args:
            int
        :description: QtWidgets/QHeaderView-updateSection-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.verticalOffset
        :returns:
            int
        :description: QtWidgets/QHeaderView-verticalOffset-f.rst

    .. sip:method:: PyQt5.QtWidgets.QHeaderView.viewportEvent
        :args:
            :sip:ref:`~PyQt5.QtCore.QEvent`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.visualIndex
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.visualIndexAt
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.visualRect
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            :sip:ref:`~PyQt5.QtCore.QRect`
    ...
    .. sip:method:: PyQt5.QtWidgets.QHeaderView.visualRegionForSelection
        :args:
    ...
    .. sip:signal:: PyQt5.QtWidgets.QHeaderView.geometriesChanged
        :description: QtWidgets/QHeaderView-geometriesChanged-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QHeaderView.sectionClicked
        :args:
            int
        :description: QtWidgets/QHeaderView-sectionClicked-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QHeaderView.sectionCountChanged
        :args:
            int
            int
        :description: QtWidgets/QHeaderView-sectionCountChanged-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QHeaderView.sectionDoubleClicked
        :args:
            int
        :description: QtWidgets/QHeaderView-sectionDoubleClicked-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QHeaderView.sectionEntered
        :args:
            int
        :description: QtWidgets/QHeaderView-sectionEntered-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QHeaderView.sectionHandleDoubleClicked
        :args:
            int
        :description: QtWidgets/QHeaderView-sectionHandleDoubleClicked-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QHeaderView.sectionMoved
        :args:
            int
            int
            int
    ...
    .. sip:signal:: PyQt5.QtWidgets.QHeaderView.sectionPressed
        :args:
            int
        :description: QtWidgets/QHeaderView-sectionPressed-s.rst

    .. sip:signal:: PyQt5.QtWidgets.QHeaderView.sectionResized
        :args:
            int
            int
            int
    ...
    .. sip:signal:: PyQt5.QtWidgets.QHeaderView.sortIndicatorChanged
        :args:
            int
            :sip:ref:`~PyQt5.QtCore.Qt.SortOrder`

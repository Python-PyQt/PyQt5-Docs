...
.. sip:class:: PyQt5.QtWidgets.QGridLayout
    :inherits: :sip:ref:`~PyQt5.QtWidgets.QLayout`
    :description: QtWidgets/QGridLayout-c.rst

    .. sip:method:: PyQt5.QtWidgets.QGridLayout.__init__
        :description: QtWidgets/QGridLayout-__init__-f.rst

    .. sip:method:: PyQt5.QtWidgets.QGridLayout.__init__
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
        :description: QtWidgets/QGridLayout-__init__-f-1.rst

    .. sip:method:: PyQt5.QtWidgets.QGridLayout.addItem
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QGridLayout.addLayout
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QGridLayout.addWidget
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
    ...
    .. sip:method:: PyQt5.QtWidgets.QGridLayout.cellRect
        :args:
            int
            int
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QGridLayout.columnCount
        :returns:
            int
        :description: QtWidgets/QGridLayout-columnCount-f.rst

    .. sip:method:: PyQt5.QtWidgets.QGridLayout.columnMinimumWidth
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QGridLayout.columnStretch
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QGridLayout.count
        :returns:
            int
        :description: QtWidgets/QGridLayout-count-f.rst

    .. sip:method:: PyQt5.QtWidgets.QGridLayout.expandingDirections
        :returns:
            :sip:ref:`~PyQt5.QtCore.Qt.Orientations`
        :description: QtWidgets/QGridLayout-expandingDirections-f.rst

    .. sip:method:: PyQt5.QtWidgets.QGridLayout.getItemPosition
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QGridLayout.hasHeightForWidth
        :returns:
            bool
        :description: QtWidgets/QGridLayout-hasHeightForWidth-f.rst

    .. sip:method:: PyQt5.QtWidgets.QGridLayout.heightForWidth
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QGridLayout.horizontalSpacing
        :returns:
            int
        :description: QtWidgets/QGridLayout-horizontalSpacing-f.rst

    .. sip:method:: PyQt5.QtWidgets.QGridLayout.invalidate
        :description: QtWidgets/QGridLayout-invalidate-f.rst

    .. sip:method:: PyQt5.QtWidgets.QGridLayout.itemAt
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QLayoutItem`
    ...
    .. sip:method:: PyQt5.QtWidgets.QGridLayout.itemAtPosition
        :args:
            int
            int
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QGridLayout.maximumSize
        :returns:
            :sip:ref:`~PyQt5.QtCore.QSize`
        :description: QtWidgets/QGridLayout-maximumSize-f.rst

    .. sip:method:: PyQt5.QtWidgets.QGridLayout.minimumHeightForWidth
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QGridLayout.minimumSize
        :returns:
            :sip:ref:`~PyQt5.QtCore.QSize`
        :description: QtWidgets/QGridLayout-minimumSize-f.rst

    .. sip:method:: PyQt5.QtWidgets.QGridLayout.originCorner
        :returns:
            :sip:ref:`~PyQt5.QtCore.Qt.Corner`
        :description: QtWidgets/QGridLayout-originCorner-f.rst

    .. sip:method:: PyQt5.QtWidgets.QGridLayout.rowCount
        :returns:
            int
        :description: QtWidgets/QGridLayout-rowCount-f.rst

    .. sip:method:: PyQt5.QtWidgets.QGridLayout.rowMinimumHeight
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QGridLayout.rowStretch
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QGridLayout.verticalSpacing
        :returns:
            int

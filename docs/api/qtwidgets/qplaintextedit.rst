...
.. sip:class:: PyQt5.QtWidgets.QPlainTextEdit
    :inherits: :sip:ref:`~PyQt5.QtWidgets.QAbstractScrollArea`
    :description: QtWidgets/QPlainTextEdit-c.rst

    .. sip:enum:: PyQt5.QtWidgets.QPlainTextEdit.LineWrapMode
        :description: QtWidgets/QPlainTextEdit-LineWrapMode-e.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QPlainTextEdit.LineWrapMode.NoWrap
            :description: QtWidgets/QPlainTextEdit-LineWrapMode-NoWrap-v.rst

        .. sip:enum-member:: PyQt5.QtWidgets.QPlainTextEdit.LineWrapMode.WidgetWidth
            :description: QtWidgets/QPlainTextEdit-LineWrapMode-WidgetWidth-v.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.__init__
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.anchorAt
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.appendHtml
        :args:
            str
        :description: QtWidgets/QPlainTextEdit-appendHtml-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.appendPlainText
        :args:
            str
        :description: QtWidgets/QPlainTextEdit-appendPlainText-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.backgroundVisible
        :returns:
            bool
        :description: QtWidgets/QPlainTextEdit-backgroundVisible-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.blockBoundingGeometry
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.blockBoundingRect
        :args:
            :sip:ref:`~PyQt5.QtGui.QTextBlock`
        :returns:
            :sip:ref:`~PyQt5.QtCore.QRectF`
    ...
    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.blockCount
        :returns:
            int
        :description: QtWidgets/QPlainTextEdit-blockCount-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.canInsertFromMimeData
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.currentCharFormat
        :returns:
            :sip:ref:`~PyQt5.QtGui.QTextCharFormat`
        :description: QtWidgets/QPlainTextEdit-currentCharFormat-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.cursorForPosition
        :args:
            :sip:ref:`~PyQt5.QtCore.QPoint`
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.cursorRect
        :returns:
    ...
    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.extraSelections
        :returns:
            List[:sip:ref:`~PyQt5.QtWidgets.QTextEdit.ExtraSelection`]
        :description: QtWidgets/QPlainTextEdit-extraSelections-f.rst
    ...
    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.focusInEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QFocusEvent`
        :description: QtWidgets/QPlainTextEdit-focusInEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.focusNextPrevChild
        :args:
            bool
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.insertFromMimeData
        :args:
            :sip:ref:`~PyQt5.QtCore.QMimeData`
        :description: QtWidgets/QPlainTextEdit-insertFromMimeData-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.insertPlainText
        :args:
            str
        :description: QtWidgets/QPlainTextEdit-insertPlainText-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.isReadOnly
        :returns:
            bool
        :description: QtWidgets/QPlainTextEdit-isReadOnly-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.isUndoRedoEnabled
        :returns:
            bool
        :description: QtWidgets/QPlainTextEdit-isUndoRedoEnabled-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.keyPressEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QKeyEvent`
        :description: QtWidgets/QPlainTextEdit-keyPressEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.keyReleaseEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QKeyEvent`
        :description: QtWidgets/QPlainTextEdit-keyReleaseEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.lineWrapMode
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QPlainTextEdit.LineWrapMode`
        :description: QtWidgets/QPlainTextEdit-lineWrapMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.loadResource
        :args:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.maximumBlockCount
        :returns:
            int
        :description: QtWidgets/QPlainTextEdit-maximumBlockCount-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.mergeCurrentCharFormat
        :args:
            :sip:ref:`~PyQt5.QtGui.QTextCharFormat`
        :description: QtWidgets/QPlainTextEdit-mergeCurrentCharFormat-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.mouseDoubleClickEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QMouseEvent`
        :description: QtWidgets/QPlainTextEdit-mouseDoubleClickEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.mouseMoveEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QMouseEvent`
        :description: QtWidgets/QPlainTextEdit-mouseMoveEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.mousePressEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QMouseEvent`
        :description: QtWidgets/QPlainTextEdit-mousePressEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.mouseReleaseEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QMouseEvent`
        :description: QtWidgets/QPlainTextEdit-mouseReleaseEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.moveCursor
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.overwriteMode
        :returns:
            bool
        :description: QtWidgets/QPlainTextEdit-overwriteMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.paintEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QPaintEvent`
        :description: QtWidgets/QPlainTextEdit-paintEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.paste
        :description: QtWidgets/QPlainTextEdit-paste-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.placeholderText
        :returns:
            str
        :description: QtWidgets/QPlainTextEdit-placeholderText-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.print
        :args:
            :sip:ref:`~PyQt5.QtGui.QPagedPaintDevice`
        :description: QtWidgets/QPlainTextEdit-print-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.print_
        :args:
            :sip:ref:`~PyQt5.QtGui.QPagedPaintDevice`
        :description: QtWidgets/QPlainTextEdit-print_-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.redo
        :description: QtWidgets/QPlainTextEdit-redo-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.resizeEvent
        :args:
            :sip:ref:`~PyQt5.QtGui.QResizeEvent`
        :description: QtWidgets/QPlainTextEdit-resizeEvent-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.scrollContentsBy
        :args:
            int
            int
        :description: QtWidgets/QPlainTextEdit-scrollContentsBy-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.selectAll
        :description: QtWidgets/QPlainTextEdit-selectAll-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setBackgroundVisible
        :args:
            bool
        :description: QtWidgets/QPlainTextEdit-setBackgroundVisible-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setCenterOnScroll
        :args:
            bool
        :description: QtWidgets/QPlainTextEdit-setCenterOnScroll-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setCurrentCharFormat
        :args:
            :sip:ref:`~PyQt5.QtGui.QTextCharFormat`
        :description: QtWidgets/QPlainTextEdit-setCurrentCharFormat-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setCursorWidth
        :args:
            int
        :description: QtWidgets/QPlainTextEdit-setCursorWidth-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setDocument
        :args:
            :sip:ref:`~PyQt5.QtGui.QTextDocument`
        :description: QtWidgets/QPlainTextEdit-setDocument-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setDocumentTitle
        :args:
            str
        :description: QtWidgets/QPlainTextEdit-setDocumentTitle-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setExtraSelections
        :args:
            Iterable[:sip:ref:`~PyQt5.QtWidgets.QTextEdit.ExtraSelection`]
        :description: QtWidgets/QPlainTextEdit-setExtraSelections-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setLineWrapMode
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QPlainTextEdit.LineWrapMode`
        :description: QtWidgets/QPlainTextEdit-setLineWrapMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setMaximumBlockCount
        :args:
            int
        :description: QtWidgets/QPlainTextEdit-setMaximumBlockCount-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setOverwriteMode
        :args:
            bool
        :description: QtWidgets/QPlainTextEdit-setOverwriteMode-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setPlaceholderText
        :args:
            str
        :description: QtWidgets/QPlainTextEdit-setPlaceholderText-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setPlainText
        :args:
            str
        :description: QtWidgets/QPlainTextEdit-setPlainText-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setReadOnly
        :args:
            bool
        :description: QtWidgets/QPlainTextEdit-setReadOnly-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setTabChangesFocus
        :args:
            bool
        :description: QtWidgets/QPlainTextEdit-setTabChangesFocus-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setTabStopDistance
        :args:
            float
        :description: QtWidgets/QPlainTextEdit-setTabStopDistance-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setTabStopWidth
        :args:
            int
        :description: QtWidgets/QPlainTextEdit-setTabStopWidth-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setTextCursor
        :args:
            :sip:ref:`~PyQt5.QtGui.QTextCursor`
        :description: QtWidgets/QPlainTextEdit-setTextCursor-f.rst

    .. sip:method:: PyQt5.QtWidgets.QPlainTextEdit.setTextInteractionFlags
        :args:

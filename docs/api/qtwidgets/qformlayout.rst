...
.. sip:class:: PyQt5.QtWidgets.QFormLayout
    ...
    .. sip:method:: PyQt5.QtWidgets.QFormLayout.count
        :returns:
            int
        :description: QtWidgets/QFormLayout-count-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.expandingDirections
        :returns:
            :sip:ref:`~PyQt5.QtCore.Qt.Orientations`
        :description: QtWidgets/QFormLayout-expandingDirections-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.fieldGrowthPolicy
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QFormLayout.FieldGrowthPolicy`
        :description: QtWidgets/QFormLayout-fieldGrowthPolicy-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.formAlignment
        :returns:
            :sip:ref:`~PyQt5.QtCore.Qt.Alignment`
        :description: QtWidgets/QFormLayout-formAlignment-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.getItemPosition
        :args:
            int
        :returns:
            int
            :sip:ref:`~PyQt5.QtWidgets.QFormLayout.ItemRole`
        :description: QtWidgets/QFormLayout-getItemPosition-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.getLayoutPosition
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QLayout`
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QFormLayout.getWidgetPosition
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QFormLayout.hasHeightForWidth
        :returns:
            bool
        :description: QtWidgets/QFormLayout-hasHeightForWidth-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.heightForWidth
        :args:
            int
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QFormLayout.horizontalSpacing
        :returns:
            int
        :description: QtWidgets/QFormLayout-horizontalSpacing-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.insertRow
        :args:
            int
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
    ...
    .. sip:method:: PyQt5.QtWidgets.QFormLayout.invalidate
        :description: QtWidgets/QFormLayout-invalidate-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.itemAt
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QLayoutItem`
    ...
    .. sip:method:: PyQt5.QtWidgets.QFormLayout.labelAlignment
        :returns:
            :sip:ref:`~PyQt5.QtCore.Qt.Alignment`
        :description: QtWidgets/QFormLayout-labelAlignment-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.labelForField
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
    ...
    .. sip:method:: PyQt5.QtWidgets.QFormLayout.minimumSize
        :returns:
            :sip:ref:`~PyQt5.QtCore.QSize`
        :description: QtWidgets/QFormLayout-minimumSize-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.removeRow
        :args:
            int
    ...
    .. sip:method:: PyQt5.QtWidgets.QFormLayout.rowCount
        :returns:
            int
        :description: QtWidgets/QFormLayout-rowCount-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.rowWrapPolicy
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QFormLayout.RowWrapPolicy`
        :description: QtWidgets/QFormLayout-rowWrapPolicy-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.setFieldGrowthPolicy
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QFormLayout.FieldGrowthPolicy`
        :description: QtWidgets/QFormLayout-setFieldGrowthPolicy-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.setFormAlignment
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QFormLayout.setGeometry
        :args:
            :sip:ref:`~PyQt5.QtCore.QRect`
        :description: QtWidgets/QFormLayout-setGeometry-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.setHorizontalSpacing
        :args:
            int
        :description: QtWidgets/QFormLayout-setHorizontalSpacing-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.setItem
        :args:
            int
            :sip:ref:`~PyQt5.QtWidgets.QFormLayout.ItemRole`
            :sip:ref:`~PyQt5.QtWidgets.QLayoutItem`
    ...
    .. sip:method:: PyQt5.QtWidgets.QFormLayout.setLabelAlignment
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.Qt.Alignment`, :sip:ref:`~PyQt5.QtCore.Qt.AlignmentFlag`]
        :description: QtWidgets/QFormLayout-setLabelAlignment-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.setLayout
        :args:
            int
            :sip:ref:`~PyQt5.QtWidgets.QFormLayout.ItemRole`
            :sip:ref:`~PyQt5.QtWidgets.QLayout`
    ...
    .. sip:method:: PyQt5.QtWidgets.QFormLayout.setRowWrapPolicy
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QFormLayout.RowWrapPolicy`
        :description: QtWidgets/QFormLayout-setRowWrapPolicy-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.setSpacing
        :args:
            int
        :description: QtWidgets/QFormLayout-setSpacing-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.setVerticalSpacing
        :args:
            int
        :description: QtWidgets/QFormLayout-setVerticalSpacing-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.setWidget
        :args:
            int
            :sip:ref:`~PyQt5.QtWidgets.QFormLayout.ItemRole`
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
    ...
    .. sip:method:: PyQt5.QtWidgets.QFormLayout.sizeHint
        :returns:
            :sip:ref:`~PyQt5.QtCore.QSize`
        :description: QtWidgets/QFormLayout-sizeHint-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.spacing
        :returns:
            int
        :description: QtWidgets/QFormLayout-spacing-f.rst

    .. sip:method:: PyQt5.QtWidgets.QFormLayout.takeAt
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QLayoutItem`
    ...
    .. sip:method:: PyQt5.QtWidgets.QFormLayout.takeRow
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtWidgets.QFormLayout.TakeRowResult`
    ...
    .. sip:method:: PyQt5.QtWidgets.QFormLayout.verticalSpacing
        :returns:
            int

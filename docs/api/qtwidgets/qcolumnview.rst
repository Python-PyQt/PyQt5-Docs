...
.. sip:class:: PyQt5.QtWidgets.QColumnView
    ...
    .. sip:method:: PyQt5.QtWidgets.QColumnView.currentChanged
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :description: QtWidgets/QColumnView-currentChanged-f.rst

    .. sip:method:: PyQt5.QtWidgets.QColumnView.horizontalOffset
        :returns:
            int
        :description: QtWidgets/QColumnView-horizontalOffset-f.rst

    .. sip:method:: PyQt5.QtWidgets.QColumnView.indexAt
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QColumnView.initializeColumn
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QAbstractItemView`
        :description: QtWidgets/QColumnView-initializeColumn-f.rst

    .. sip:method:: PyQt5.QtWidgets.QColumnView.isIndexHidden
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWidgets.QColumnView.moveCursor
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QColumnView.scrollContentsBy
        :args:
            int
            int
        :description: QtWidgets/QColumnView-scrollContentsBy-f.rst

    .. sip:method:: PyQt5.QtWidgets.QColumnView.scrollTo
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
    ...
    .. sip:method:: PyQt5.QtWidgets.QColumnView.selectAll
        :description: QtWidgets/QColumnView-selectAll-f.rst

    .. sip:method:: PyQt5.QtWidgets.QColumnView.setColumnWidths
        :args:
            Iterable[int]
        :description: QtWidgets/QColumnView-setColumnWidths-f.rst

    .. sip:method:: PyQt5.QtWidgets.QColumnView.setModel
        :args:
            :sip:ref:`~PyQt5.QtCore.QAbstractItemModel`
        :description: QtWidgets/QColumnView-setModel-f.rst

    .. sip:method:: PyQt5.QtWidgets.QColumnView.setPreviewWidget
        :args:
            :sip:ref:`~PyQt5.QtWidgets.QWidget`
        :description: QtWidgets/QColumnView-setPreviewWidget-f.rst

    .. sip:method:: PyQt5.QtWidgets.QColumnView.setResizeGripsVisible
        :args:
            bool
        :description: QtWidgets/QColumnView-setResizeGripsVisible-f.rst

    .. sip:method:: PyQt5.QtWidgets.QColumnView.setRootIndex
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :description: QtWidgets/QColumnView-setRootIndex-f.rst

    .. sip:method:: PyQt5.QtWidgets.QColumnView.setSelection
        :args:
    ...
    .. sip:method:: PyQt5.QtWidgets.QColumnView.visualRegionForSelection
        :args:
    ...
    .. sip:signal:: PyQt5.QtWidgets.QColumnView.updatePreviewWidget
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`

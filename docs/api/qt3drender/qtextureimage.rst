...
.. sip:class:: PyQt5.Qt3DRender.QTextureImage
    ...
    .. sip:method:: PyQt5.Qt3DRender.QTextureImage.__init__
        :args:
            parent: :sip:ref:`~PyQt5.Qt3DCore.QNode` = None
        :description: Qt3DRender/QTextureImage-__init__-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QTextureImage.isMirrored
        :returns:
            bool
        :description: Qt3DRender/QTextureImage-isMirrored-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QTextureImage.sceneChangeEvent
        :args:
            :sip:ref:`~PyQt5.Qt3DCore.QSceneChange`
        :description: Qt3DRender/QTextureImage-sceneChangeEvent-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QTextureImage.setMirrored
        :args:
            bool
        :description: Qt3DRender/QTextureImage-setMirrored-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QTextureImage.setSource
        :args:
            :sip:ref:`~PyQt5.QtCore.QUrl`
        :description: Qt3DRender/QTextureImage-setSource-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QTextureImage.setStatus
        :args:
            :sip:ref:`~PyQt5.Qt3DRender.QTextureImage.Status`
        :description: Qt3DRender/QTextureImage-setStatus-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QTextureImage.source
        :returns:
            :sip:ref:`~PyQt5.QtCore.QUrl`
        :description: Qt3DRender/QTextureImage-source-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QTextureImage.status
        :returns:
            :sip:ref:`~PyQt5.Qt3DRender.QTextureImage.Status`
        :description: Qt3DRender/QTextureImage-status-f.rst

    .. sip:signal:: PyQt5.Qt3DRender.QTextureImage.mirroredChanged
        :args:
            bool
        :description: Qt3DRender/QTextureImage-mirroredChanged-s.rst

    .. sip:signal:: PyQt5.Qt3DRender.QTextureImage.sourceChanged
        :args:
            :sip:ref:`~PyQt5.QtCore.QUrl`
        :description: Qt3DRender/QTextureImage-sourceChanged-s.rst

    .. sip:signal:: PyQt5.Qt3DRender.QTextureImage.statusChanged
        :args:
            :sip:ref:`~PyQt5.Qt3DRender.QTextureImage.Status`

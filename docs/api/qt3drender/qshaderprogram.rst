...
.. sip:class:: PyQt5.Qt3DRender.QShaderProgram
    ...
    .. sip:enum:: PyQt5.Qt3DRender.QShaderProgram.ShaderType
        ...
        .. sip:enum-member:: PyQt5.Qt3DRender.QShaderProgram.ShaderType.Compute
            :description: Qt3DRender/QShaderProgram-ShaderType-Compute-v.rst

        .. sip:enum-member:: PyQt5.Qt3DRender.QShaderProgram.ShaderType.Fragment
            :description: Qt3DRender/QShaderProgram-ShaderType-Fragment-v.rst

        .. sip:enum-member:: PyQt5.Qt3DRender.QShaderProgram.ShaderType.Geometry
            :description: Qt3DRender/QShaderProgram-ShaderType-Geometry-v.rst

        .. sip:enum-member:: PyQt5.Qt3DRender.QShaderProgram.ShaderType.TessellationControl
            :description: Qt3DRender/QShaderProgram-ShaderType-TessellationControl-v.rst

        .. sip:enum-member:: PyQt5.Qt3DRender.QShaderProgram.ShaderType.TessellationEvaluation
            :description: Qt3DRender/QShaderProgram-ShaderType-TessellationEvaluation-v.rst

        .. sip:enum-member:: PyQt5.Qt3DRender.QShaderProgram.ShaderType.Vertex
            :description: Qt3DRender/QShaderProgram-ShaderType-Vertex-v.rst

    .. sip:enum:: PyQt5.Qt3DRender.QShaderProgram.Status
        :description: Qt3DRender/QShaderProgram-Status-e.rst

        .. sip:enum-member:: PyQt5.Qt3DRender.QShaderProgram.Status.Error
            :description: Qt3DRender/QShaderProgram-Status-Error-v.rst

        .. sip:enum-member:: PyQt5.Qt3DRender.QShaderProgram.Status.NotReady
            :description: Qt3DRender/QShaderProgram-Status-NotReady-v.rst

        .. sip:enum-member:: PyQt5.Qt3DRender.QShaderProgram.Status.Ready
            :description: Qt3DRender/QShaderProgram-Status-Ready-v.rst

    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.__init__
        :args:
            parent: :sip:ref:`~PyQt5.Qt3DCore.QNode` = None
        :description: Qt3DRender/QShaderProgram-__init__-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.computeShaderCode
        :returns:
    ...
    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.geometryShaderCode
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: Qt3DRender/QShaderProgram-geometryShaderCode-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.loadSource
        :args:
    ...
    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.log
        :returns:
            str
        :description: Qt3DRender/QShaderProgram-log-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.sceneChangeEvent
        :args:
            :sip:ref:`~PyQt5.Qt3DCore.QSceneChange`
        :description: Qt3DRender/QShaderProgram-sceneChangeEvent-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.setComputeShaderCode
        :args:
    ...
    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.setGeometryShaderCode
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :description: Qt3DRender/QShaderProgram-setGeometryShaderCode-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.setShaderCode
        :args:
            :sip:ref:`~PyQt5.Qt3DRender.QShaderProgram.ShaderType`
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :description: Qt3DRender/QShaderProgram-setShaderCode-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.setTessellationControlShaderCode
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :description: Qt3DRender/QShaderProgram-setTessellationControlShaderCode-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.setTessellationEvaluationShaderCode
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :description: Qt3DRender/QShaderProgram-setTessellationEvaluationShaderCode-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.setVertexShaderCode
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :description: Qt3DRender/QShaderProgram-setVertexShaderCode-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.shaderCode
        :args:
            :sip:ref:`~PyQt5.Qt3DRender.QShaderProgram.ShaderType`
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
    ...
    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.status
        :returns:
            :sip:ref:`~PyQt5.Qt3DRender.QShaderProgram.Status`
        :description: Qt3DRender/QShaderProgram-status-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.tessellationControlShaderCode
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: Qt3DRender/QShaderProgram-tessellationControlShaderCode-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.tessellationEvaluationShaderCode
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: Qt3DRender/QShaderProgram-tessellationEvaluationShaderCode-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QShaderProgram.vertexShaderCode
        :returns:
            :sip:ref:`~PyQt5.QtCore.QByteArray`
        :description: Qt3DRender/QShaderProgram-vertexShaderCode-f.rst

    .. sip:signal:: PyQt5.Qt3DRender.QShaderProgram.computeShaderCodeChanged
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
    ...
    .. sip:signal:: PyQt5.Qt3DRender.QShaderProgram.geometryShaderCodeChanged
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :description: Qt3DRender/QShaderProgram-geometryShaderCodeChanged-s.rst

    .. sip:signal:: PyQt5.Qt3DRender.QShaderProgram.logChanged
        :args:
            str
        :description: Qt3DRender/QShaderProgram-logChanged-s.rst

    .. sip:signal:: PyQt5.Qt3DRender.QShaderProgram.statusChanged
        :args:
            :sip:ref:`~PyQt5.Qt3DRender.QShaderProgram.Status`
        :description: Qt3DRender/QShaderProgram-statusChanged-s.rst

    .. sip:signal:: PyQt5.Qt3DRender.QShaderProgram.tessellationControlShaderCodeChanged
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :description: Qt3DRender/QShaderProgram-tessellationControlShaderCodeChanged-s.rst

    .. sip:signal:: PyQt5.Qt3DRender.QShaderProgram.tessellationEvaluationShaderCodeChanged
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]
        :description: Qt3DRender/QShaderProgram-tessellationEvaluationShaderCodeChanged-s.rst

    .. sip:signal:: PyQt5.Qt3DRender.QShaderProgram.vertexShaderCodeChanged
        :args:
            Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]

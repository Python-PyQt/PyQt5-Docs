...
.. sip:class:: PyQt5.Qt3DRender.QClearBuffers
    :inherits: :sip:ref:`~PyQt5.Qt3DRender.QFrameGraphNode`
    :description: Qt3DRender/QClearBuffers-c.rst

    .. sip:enum:: PyQt5.Qt3DRender.QClearBuffers.BufferType
        :description: Qt3DRender/QClearBuffers-BufferType-e.rst

        .. sip:enum-member:: PyQt5.Qt3DRender.QClearBuffers.BufferType.AllBuffers
            :description: Qt3DRender/QClearBuffers-BufferType-AllBuffers-v.rst

        .. sip:enum-member:: PyQt5.Qt3DRender.QClearBuffers.BufferType.ColorBuffer
            :description: Qt3DRender/QClearBuffers-BufferType-ColorBuffer-v.rst

        .. sip:enum-member:: PyQt5.Qt3DRender.QClearBuffers.BufferType.ColorDepthBuffer
            :description: Qt3DRender/QClearBuffers-BufferType-ColorDepthBuffer-v.rst

        .. sip:enum-member:: PyQt5.Qt3DRender.QClearBuffers.BufferType.ColorDepthStencilBuffer
            :description: Qt3DRender/QClearBuffers-BufferType-ColorDepthStencilBuffer-v.rst

        .. sip:enum-member:: PyQt5.Qt3DRender.QClearBuffers.BufferType.DepthBuffer
    ...
    .. sip:method:: PyQt5.Qt3DRender.QClearBuffers.setClearDepthValue
        :args:
            float
        :description: Qt3DRender/QClearBuffers-setClearDepthValue-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QClearBuffers.setClearStencilValue
        :args:
            int
        :description: Qt3DRender/QClearBuffers-setClearStencilValue-f.rst

    .. sip:method:: PyQt5.Qt3DRender.QClearBuffers.setColorBuffer
        :args:
            :sip:ref:`~PyQt5.Qt3DRender.QRenderTargetOutput`
        :description: Qt3DRender/QClearBuffers-setColorBuffer-f.rst

    .. sip:signal:: PyQt5.Qt3DRender.QClearBuffers.buffersChanged
        :args:
            :sip:ref:`~PyQt5.Qt3DRender.QClearBuffers.BufferType`
        :description: Qt3DRender/QClearBuffers-buffersChanged-s.rst

    .. sip:signal:: PyQt5.Qt3DRender.QClearBuffers.clearColorChanged
        :args:
            Union[:sip:ref:`~PyQt5.QtGui.QColor`, :sip:ref:`~PyQt5.QtCore.Qt.GlobalColor`]
        :description: Qt3DRender/QClearBuffers-clearColorChanged-s.rst

    .. sip:signal:: PyQt5.Qt3DRender.QClearBuffers.clearDepthValueChanged
        :args:
            float
        :description: Qt3DRender/QClearBuffers-clearDepthValueChanged-s.rst

    .. sip:signal:: PyQt5.Qt3DRender.QClearBuffers.clearStencilValueChanged
        :args:
            int
        :description: Qt3DRender/QClearBuffers-clearStencilValueChanged-s.rst

    .. sip:signal:: PyQt5.Qt3DRender.QClearBuffers.colorBufferChanged
        :args:
            :sip:ref:`~PyQt5.Qt3DRender.QRenderTargetOutput`

...
.. sip:class:: PyQt5.Qt3DInput.QMouseDevice
    ...
    .. sip:method:: PyQt5.Qt3DInput.QMouseDevice.axisNames
        :returns:
            List[str]
        :description: Qt3DInput/QMouseDevice-axisNames-f.rst

    .. sip:method:: PyQt5.Qt3DInput.QMouseDevice.buttonCount
        :returns:
            int
        :description: Qt3DInput/QMouseDevice-buttonCount-f.rst

    .. sip:method:: PyQt5.Qt3DInput.QMouseDevice.buttonIdentifier
        :args:
            str
        :returns:
            int
    ...
    .. sip:method:: PyQt5.Qt3DInput.QMouseDevice.buttonNames
        :returns:
            List[str]
        :description: Qt3DInput/QMouseDevice-buttonNames-f.rst

    .. sip:method:: PyQt5.Qt3DInput.QMouseDevice.sceneChangeEvent
        :args:
            :sip:ref:`~PyQt5.Qt3DCore.QSceneChange`
        :description: Qt3DInput/QMouseDevice-sceneChangeEvent-f.rst

    .. sip:method:: PyQt5.Qt3DInput.QMouseDevice.sensitivity
        :returns:
            float
        :description: Qt3DInput/QMouseDevice-sensitivity-f.rst

    .. sip:method:: PyQt5.Qt3DInput.QMouseDevice.setSensitivity
        :args:
            float

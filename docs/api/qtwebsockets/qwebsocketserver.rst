...
.. sip:class:: PyQt5.QtWebSockets.QWebSocketServer
    :inherits: :sip:ref:`~PyQt5.QtCore.QObject`
    :description: QtWebSockets/QWebSocketServer-c.rst

    .. sip:enum:: PyQt5.QtWebSockets.QWebSocketServer.SslMode
        :description: QtWebSockets/QWebSocketServer-SslMode-e.rst

        .. sip:enum-member:: PyQt5.QtWebSockets.QWebSocketServer.SslMode.NonSecureMode
            :description: QtWebSockets/QWebSocketServer-SslMode-NonSecureMode-v.rst

        .. sip:enum-member:: PyQt5.QtWebSockets.QWebSocketServer.SslMode.SecureMode
            :description: QtWebSockets/QWebSocketServer-SslMode-SecureMode-v.rst

    .. sip:method:: PyQt5.QtWebSockets.QWebSocketServer.__init__
        :args:
            str
            :sip:ref:`~PyQt5.QtWebSockets.QWebSocketServer.SslMode`
            parent: :sip:ref:`~PyQt5.QtCore.QObject` = None
        :description: QtWebSockets/QWebSocketServer-__init__-f.rst

    .. sip:method:: PyQt5.QtWebSockets.QWebSocketServer.close
        :description: QtWebSockets/QWebSocketServer-close-f.rst

    .. sip:method:: PyQt5.QtWebSockets.QWebSocketServer.error
        :returns:
            :sip:ref:`~PyQt5.QtWebSockets.QWebSocketProtocol.CloseCode`
        :description: QtWebSockets/QWebSocketServer-error-f.rst

    .. sip:method:: PyQt5.QtWebSockets.QWebSocketServer.errorString
        :returns:
            str
        :description: QtWebSockets/QWebSocketServer-errorString-f.rst

    .. sip:method:: PyQt5.QtWebSockets.QWebSocketServer.handleConnection
        :args:
    ...
    .. sip:method:: PyQt5.QtWebSockets.QWebSocketServer.isListening
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWebSockets.QWebSocketServer.setServerName
        :args:
            str
        :description: QtWebSockets/QWebSocketServer-setServerName-f.rst

    .. sip:method:: PyQt5.QtWebSockets.QWebSocketServer.setSocketDescriptor
        :args:
            int
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtWebSockets.QWebSocketServer.setSslConfiguration
        :args:
            :sip:ref:`~PyQt5.QtNetwork.QSslConfiguration`
        :description: QtWebSockets/QWebSocketServer-setSslConfiguration-f.rst

    .. sip:method:: PyQt5.QtWebSockets.QWebSocketServer.socketDescriptor
        :returns:
            int
        :description: QtWebSockets/QWebSocketServer-socketDescriptor-f.rst

    .. sip:method:: PyQt5.QtWebSockets.QWebSocketServer.sslConfiguration
        :returns:
            :sip:ref:`~PyQt5.QtNetwork.QSslConfiguration`
        :description: QtWebSockets/QWebSocketServer-sslConfiguration-f.rst

    .. sip:method:: PyQt5.QtWebSockets.QWebSocketServer.supportedVersions
        :returns:
            List[:sip:ref:`~PyQt5.QtWebSockets.QWebSocketProtocol.Version`]
        :description: QtWebSockets/QWebSocketServer-supportedVersions-f.rst

    .. sip:signal:: PyQt5.QtWebSockets.QWebSocketServer.acceptError
        :args:
            :sip:ref:`~PyQt5.QtNetwork.QAbstractSocket.SocketError`
        :description: QtWebSockets/QWebSocketServer-acceptError-s.rst

    .. sip:signal:: PyQt5.QtWebSockets.QWebSocketServer.closed
        :description: QtWebSockets/QWebSocketServer-closed-s.rst

    .. sip:signal:: PyQt5.QtWebSockets.QWebSocketServer.newConnection
        :description: QtWebSockets/QWebSocketServer-newConnection-s.rst

    .. sip:signal:: PyQt5.QtWebSockets.QWebSocketServer.originAuthenticationRequired
        :args:
            :sip:ref:`~PyQt5.QtWebSockets.QWebSocketCorsAuthenticator`
        :description: QtWebSockets/QWebSocketServer-originAuthenticationRequired-s.rst

    .. sip:signal:: PyQt5.QtWebSockets.QWebSocketServer.peerVerifyError
        :args:
            :sip:ref:`~PyQt5.QtNetwork.QSslError`
        :description: QtWebSockets/QWebSocketServer-peerVerifyError-s.rst

    .. sip:signal:: PyQt5.QtWebSockets.QWebSocketServer.preSharedKeyAuthenticationRequired
        :args:
    ...
    .. sip:signal:: PyQt5.QtWebSockets.QWebSocketServer.serverError
        :args:
            :sip:ref:`~PyQt5.QtWebSockets.QWebSocketProtocol.CloseCode`
        :description: QtWebSockets/QWebSocketServer-serverError-s.rst

    .. sip:signal:: PyQt5.QtWebSockets.QWebSocketServer.sslErrors
        :args:

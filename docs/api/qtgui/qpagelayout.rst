...
.. sip:class:: PyQt5.QtGui.QPageLayout
    :description: QtGui/QPageLayout-c.rst

    .. sip:enum:: PyQt5.QtGui.QPageLayout.Mode
        :description: QtGui/QPageLayout-Mode-e.rst

        .. sip:enum-member:: PyQt5.QtGui.QPageLayout.Mode.FullPageMode
            :description: QtGui/QPageLayout-Mode-FullPageMode-v.rst

        .. sip:enum-member:: PyQt5.QtGui.QPageLayout.Mode.StandardMode
            :description: QtGui/QPageLayout-Mode-StandardMode-v.rst

    .. sip:enum:: PyQt5.QtGui.QPageLayout.Orientation
        :description: QtGui/QPageLayout-Orientation-e.rst

        .. sip:enum-member:: PyQt5.QtGui.QPageLayout.Orientation.Landscape
            :description: QtGui/QPageLayout-Orientation-Landscape-v.rst

        .. sip:enum-member:: PyQt5.QtGui.QPageLayout.Orientation.Portrait
            :description: QtGui/QPageLayout-Orientation-Portrait-v.rst

    .. sip:enum:: PyQt5.QtGui.QPageLayout.Unit
        :description: QtGui/QPageLayout-Unit-e.rst

        .. sip:enum-member:: PyQt5.QtGui.QPageLayout.Unit.Cicero
            :description: QtGui/QPageLayout-Unit-Cicero-v.rst

        .. sip:enum-member:: PyQt5.QtGui.QPageLayout.Unit.Didot
            :description: QtGui/QPageLayout-Unit-Didot-v.rst

        .. sip:enum-member:: PyQt5.QtGui.QPageLayout.Unit.Inch
            :description: QtGui/QPageLayout-Unit-Inch-v.rst

        .. sip:enum-member:: PyQt5.QtGui.QPageLayout.Unit.Millimeter
            :description: QtGui/QPageLayout-Unit-Millimeter-v.rst

        .. sip:enum-member:: PyQt5.QtGui.QPageLayout.Unit.Pica
            :description: QtGui/QPageLayout-Unit-Pica-v.rst

        .. sip:enum-member:: PyQt5.QtGui.QPageLayout.Unit.Point
            :description: QtGui/QPageLayout-Unit-Point-v.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.__init__
        :description: QtGui/QPageLayout-__init__-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.__init__
        :args:
            :sip:ref:`~PyQt5.QtGui.QPageLayout`
        :description: QtGui/QPageLayout-__init__-f-1.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.__init__
        :args:
            :sip:ref:`~PyQt5.QtGui.QPageSize`
            :sip:ref:`~PyQt5.QtGui.QPageLayout.Orientation`
            :sip:ref:`~PyQt5.QtCore.QMarginsF`
            units: :sip:ref:`~PyQt5.QtGui.QPageLayout.Unit` = :sip:ref:`~PyQt5.QtGui.QPageLayout.Unit.Point`
            minMargins: :sip:ref:`~PyQt5.QtCore.QMarginsF` = QMarginsF(0,0,0,0)
        :description: QtGui/QPageLayout-__init__-f-2.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.__eq__
        :args:
            :sip:ref:`~PyQt5.QtGui.QPageLayout`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtGui.QPageLayout.fullRect
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QPageLayout.fullRect
        :args:
            :sip:ref:`~PyQt5.QtGui.QPageLayout.Unit`
        :returns:
            :sip:ref:`~PyQt5.QtCore.QRectF`
        :description: QtGui/QPageLayout-fullRect-f-1.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.fullRectPixels
        :args:
            int
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QPageLayout.fullRectPoints
        :returns:
            :sip:ref:`~PyQt5.QtCore.QRect`
        :description: QtGui/QPageLayout-fullRectPoints-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.isEquivalentTo
        :args:
            :sip:ref:`~PyQt5.QtGui.QPageLayout`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtGui.QPageLayout.isValid
        :returns:
            bool
        :description: QtGui/QPageLayout-isValid-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.margins
        :returns:
            :sip:ref:`~PyQt5.QtCore.QMarginsF`
    ...
    .. sip:method:: PyQt5.QtGui.QPageLayout.marginsPixels
        :args:
            int
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QPageLayout.marginsPoints
        :returns:
            :sip:ref:`~PyQt5.QtCore.QMargins`
        :description: QtGui/QPageLayout-marginsPoints-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.maximumMargins
        :returns:
            :sip:ref:`~PyQt5.QtCore.QMarginsF`
        :description: QtGui/QPageLayout-maximumMargins-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.minimumMargins
        :returns:
            :sip:ref:`~PyQt5.QtCore.QMarginsF`
        :description: QtGui/QPageLayout-minimumMargins-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.mode
        :returns:
            :sip:ref:`~PyQt5.QtGui.QPageLayout.Mode`
        :description: QtGui/QPageLayout-mode-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.__ne__
        :args:
            :sip:ref:`~PyQt5.QtGui.QPageLayout`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtGui.QPageLayout.orientation
        :returns:
            :sip:ref:`~PyQt5.QtGui.QPageLayout.Orientation`
        :description: QtGui/QPageLayout-orientation-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.pageSize
        :returns:
            :sip:ref:`~PyQt5.QtGui.QPageSize`
        :description: QtGui/QPageLayout-pageSize-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.paintRect
        :returns:
            :sip:ref:`~PyQt5.QtCore.QRectF`
    ...
    .. sip:method:: PyQt5.QtGui.QPageLayout.paintRectPixels
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtCore.QRect`
    ...
    .. sip:method:: PyQt5.QtGui.QPageLayout.paintRectPoints
        :returns:
            :sip:ref:`~PyQt5.QtCore.QRect`
        :description: QtGui/QPageLayout-paintRectPoints-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.setBottomMargin
        :args:
            float
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtGui.QPageLayout.setLeftMargin
        :args:
            float
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtGui.QPageLayout.setMargins
        :args:
            :sip:ref:`~PyQt5.QtCore.QMarginsF`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtGui.QPageLayout.setMinimumMargins
        :args:
            :sip:ref:`~PyQt5.QtCore.QMarginsF`
        :description: QtGui/QPageLayout-setMinimumMargins-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.setMode
        :args:
            :sip:ref:`~PyQt5.QtGui.QPageLayout.Mode`
        :description: QtGui/QPageLayout-setMode-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.setOrientation
        :args:
            :sip:ref:`~PyQt5.QtGui.QPageLayout.Orientation`
        :description: QtGui/QPageLayout-setOrientation-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.setPageSize
        :args:
            :sip:ref:`~PyQt5.QtGui.QPageSize`
            minMargins: :sip:ref:`~PyQt5.QtCore.QMarginsF` = QMarginsF(0,0,0,0)
        :description: QtGui/QPageLayout-setPageSize-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.setRightMargin
        :args:
            float
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtGui.QPageLayout.setTopMargin
        :args:
            float
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtGui.QPageLayout.setUnits
        :args:
            :sip:ref:`~PyQt5.QtGui.QPageLayout.Unit`
        :description: QtGui/QPageLayout-setUnits-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.swap
        :args:
            :sip:ref:`~PyQt5.QtGui.QPageLayout`
        :description: QtGui/QPageLayout-swap-f.rst

    .. sip:method:: PyQt5.QtGui.QPageLayout.units
        :returns:
            :sip:ref:`~PyQt5.QtGui.QPageLayout.Unit`

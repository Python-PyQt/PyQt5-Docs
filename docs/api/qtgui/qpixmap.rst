...
.. sip:class:: PyQt5.QtGui.QPixmap
    ...
    .. sip:method:: PyQt5.QtGui.QPixmap.convertFromImage
        :args:
            :sip:ref:`~PyQt5.QtGui.QImage`
            flags: Union[:sip:ref:`~PyQt5.QtCore.Qt.ImageConversionFlags`, :sip:ref:`~PyQt5.QtCore.Qt.ImageConversionFlag`] = :sip:ref:`~PyQt5.QtCore.Qt.ImageConversionFlag.AutoColor`
        :returns:
            bool
        :description: QtGui/QPixmap-convertFromImage-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.copy
        :args:
    ...
    .. sip:method:: PyQt5.QtGui.QPixmap.createHeuristicMask
        :args:
            clipTight: bool = True
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QPixmap.createMaskFromColor
        :args:
    ...
    .. sip:method:: PyQt5.QtGui.QPixmap.defaultDepth
        :returns:
            int
        :static:
        :description: QtGui/QPixmap-defaultDepth-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.depth
        :returns:
            int
        :description: QtGui/QPixmap-depth-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.detach
        :description: QtGui/QPixmap-detach-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.devicePixelRatio
        :returns:
            float
        :description: QtGui/QPixmap-devicePixelRatio-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.devType
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtGui.QPixmap.fromImage
        ...
        :returns:
            :sip:ref:`~PyQt5.QtGui.QPixmap`
        :static:
        :description: QtGui/QPixmap-fromImage-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.fromImageReader
        :args:
            :sip:ref:`~PyQt5.QtGui.QImageReader`
            flags: Union[:sip:ref:`~PyQt5.QtCore.Qt.ImageConversionFlags`, :sip:ref:`~PyQt5.QtCore.Qt.ImageConversionFlag`] = :sip:ref:`~PyQt5.QtCore.Qt.ImageConversionFlag.AutoColor`
        :returns:
            :sip:ref:`~PyQt5.QtGui.QPixmap`
        :static:
        :description: QtGui/QPixmap-fromImageReader-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.hasAlpha
        :returns:
            bool
        :description: QtGui/QPixmap-hasAlpha-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.hasAlphaChannel
        :returns:
            bool
        :description: QtGui/QPixmap-hasAlphaChannel-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.height
        :returns:
            int
        :description: QtGui/QPixmap-height-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.isNull
        :returns:
            bool
        :description: QtGui/QPixmap-isNull-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.isQBitmap
        :returns:
            bool
        :description: QtGui/QPixmap-isQBitmap-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.load
        :args:
            str
            format: str = None
            flags: Union[:sip:ref:`~PyQt5.QtCore.Qt.ImageConversionFlags`, :sip:ref:`~PyQt5.QtCore.Qt.ImageConversionFlag`] = :sip:ref:`~PyQt5.QtCore.Qt.ImageConversionFlag.AutoColor`
    ...
    .. sip:method:: PyQt5.QtGui.QPixmap.loadFromData
        :args:
            bytes
            format: str = None
            flags: Union[:sip:ref:`~PyQt5.QtCore.Qt.ImageConversionFlags`, :sip:ref:`~PyQt5.QtCore.Qt.ImageConversionFlag`] = :sip:ref:`~PyQt5.QtCore.Qt.ImageConversionFlag.AutoColor`
    ...
    .. sip:method:: PyQt5.QtGui.QPixmap.loadFromData
        ...
        :returns:
            bool
        :description: QtGui/QPixmap-loadFromData-f-1.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.mask
        :returns:
            :sip:ref:`~PyQt5.QtGui.QBitmap`
        :description: QtGui/QPixmap-mask-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.metric
        :args:
    ...
    .. sip:method:: PyQt5.QtGui.QPixmap.scaled
        :args:
            :sip:ref:`~PyQt5.QtCore.QSize`
    ...
    .. sip:method:: PyQt5.QtGui.QPixmap.scaledToHeight
        :args:
            int
    ...
    .. sip:method:: PyQt5.QtGui.QPixmap.scaledToWidth
        :args:
            int
            mode: :sip:ref:`~PyQt5.QtCore.Qt.TransformationMode` = :sip:ref:`~PyQt5.QtCore.Qt.TransformationMode.FastTransformation`
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QPixmap.scroll
        :args:
            int
            int
            :sip:ref:`~PyQt5.QtCore.QRect`
    ...
    .. sip:method:: PyQt5.QtGui.QPixmap.setDevicePixelRatio
        :args:
            float
        :description: QtGui/QPixmap-setDevicePixelRatio-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.setMask
        :args:
            :sip:ref:`~PyQt5.QtGui.QBitmap`
        :description: QtGui/QPixmap-setMask-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.size
        :returns:
            :sip:ref:`~PyQt5.QtCore.QSize`
        :description: QtGui/QPixmap-size-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.swap
        :args:
            :sip:ref:`~PyQt5.QtGui.QPixmap`
        :description: QtGui/QPixmap-swap-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.toImage
        :returns:
            :sip:ref:`~PyQt5.QtGui.QImage`
        :description: QtGui/QPixmap-toImage-f.rst

    .. sip:method:: PyQt5.QtGui.QPixmap.transformed
        :args:
    ...
    .. sip:method:: PyQt5.QtGui.QPixmap.trueMatrix
        :args:
            :sip:ref:`~PyQt5.QtGui.QTransform`
            int
            int
    ...
    .. sip:method:: PyQt5.QtGui.QPixmap.width
        :returns:
            int

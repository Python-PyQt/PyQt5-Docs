...
.. sip:class:: PyQt5.QtGui.QStandardItemModel
    :inherits: :sip:ref:`~PyQt5.QtCore.QAbstractItemModel`
    :description: QtGui/QStandardItemModel-c.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.__init__
        :args:
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.appendColumn
        :args:
            Iterable[:sip:ref:`~PyQt5.QtGui.QStandardItem`]
        :description: QtGui/QStandardItemModel-appendColumn-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.appendRow
        :args:
            Iterable[:sip:ref:`~PyQt5.QtGui.QStandardItem`]
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.clear
        :description: QtGui/QStandardItemModel-clear-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.clearItemData
        :args:
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.columnCount
        :args:
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.data
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.dropMimeData
        :args:
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.findItems
        :args:
            str
            flags: Union[:sip:ref:`~PyQt5.QtCore.Qt.MatchFlags`, :sip:ref:`~PyQt5.QtCore.Qt.MatchFlag`] = :sip:ref:`~PyQt5.QtCore.Qt.MatchFlag.MatchExactly`
            column: int = 0
        :returns:
            List[:sip:ref:`~PyQt5.QtGui.QStandardItem`]
        :description: QtGui/QStandardItemModel-findItems-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.flags
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.hasChildren
        :args:
            parent: :sip:ref:`~PyQt5.QtCore.QModelIndex` = QModelIndex()
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.headerData
        :args:
            int
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.horizontalHeaderItem
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtGui.QStandardItem`
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.index
        :args:
            int
            int
            parent: :sip:ref:`~PyQt5.QtCore.QModelIndex` = QModelIndex()
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.indexFromItem
        :args:
            :sip:ref:`~PyQt5.QtGui.QStandardItem`
        :returns:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.insertColumn
        :args:
            int
            Iterable[:sip:ref:`~PyQt5.QtGui.QStandardItem`]
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.insertColumns
        :args:
            int
            int
            parent: :sip:ref:`~PyQt5.QtCore.QModelIndex` = QModelIndex()
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.insertRow
        :args:
            int
            Iterable[:sip:ref:`~PyQt5.QtGui.QStandardItem`]
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.insertRows
        :args:
            int
            int
            parent: :sip:ref:`~PyQt5.QtCore.QModelIndex` = QModelIndex()
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.invisibleRootItem
        :returns:
            :sip:ref:`~PyQt5.QtGui.QStandardItem`
        :description: QtGui/QStandardItemModel-invisibleRootItem-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.item
        :args:
            int
            column: int = 0
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.itemData
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            Dict[int, Any]
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.itemFromIndex
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            :sip:ref:`~PyQt5.QtGui.QStandardItem`
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.itemPrototype
        :returns:
            :sip:ref:`~PyQt5.QtGui.QStandardItem`
        :description: QtGui/QStandardItemModel-itemPrototype-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.mimeData
        :args:
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.mimeTypes
        :returns:
            List[str]
        :description: QtGui/QStandardItemModel-mimeTypes-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.parent
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.removeColumns
        :args:
            int
            int
            parent: :sip:ref:`~PyQt5.QtCore.QModelIndex` = QModelIndex()
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.removeRows
        :args:
            int
            int
            parent: :sip:ref:`~PyQt5.QtCore.QModelIndex` = QModelIndex()
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.rowCount
        :args:
            parent: :sip:ref:`~PyQt5.QtCore.QModelIndex` = QModelIndex()
        :returns:
            int
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.setColumnCount
        :args:
            int
        :description: QtGui/QStandardItemModel-setColumnCount-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.setData
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            Any
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.setHeaderData
        :args:
            int
            :sip:ref:`~PyQt5.QtCore.Qt.Orientation`
            Any
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.setHorizontalHeaderItem
        :args:
            int
            :sip:ref:`~PyQt5.QtGui.QStandardItem`
        :description: QtGui/QStandardItemModel-setHorizontalHeaderItem-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.setHorizontalHeaderLabels
        :args:
            Iterable[str]
        :description: QtGui/QStandardItemModel-setHorizontalHeaderLabels-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.setItem
        :args:
            int
            :sip:ref:`~PyQt5.QtGui.QStandardItem`
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.setItemData
        :args:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
            Dict[int, Any]
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.setItemPrototype
        :args:
            :sip:ref:`~PyQt5.QtGui.QStandardItem`
        :description: QtGui/QStandardItemModel-setItemPrototype-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.setItemRoleNames
        :args:
            Dict[int, Union[:sip:ref:`~PyQt5.QtCore.QByteArray`, bytes, bytearray]]
        :description: QtGui/QStandardItemModel-setItemRoleNames-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.setRowCount
        :args:
            int
        :description: QtGui/QStandardItemModel-setRowCount-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.setSortRole
        :args:
            int
        :description: QtGui/QStandardItemModel-setSortRole-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.setVerticalHeaderItem
        :args:
            int
            :sip:ref:`~PyQt5.QtGui.QStandardItem`
        :description: QtGui/QStandardItemModel-setVerticalHeaderItem-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.setVerticalHeaderLabels
        :args:
            Iterable[str]
        :description: QtGui/QStandardItemModel-setVerticalHeaderLabels-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.sibling
        :args:
            int
            int
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :returns:
            :sip:ref:`~PyQt5.QtCore.QModelIndex`
        :description: QtGui/QStandardItemModel-sibling-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.sort
        :args:
            int
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.sortRole
        :returns:
            int
        :description: QtGui/QStandardItemModel-sortRole-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.supportedDropActions
        :returns:
            :sip:ref:`~PyQt5.QtCore.Qt.DropActions`
        :description: QtGui/QStandardItemModel-supportedDropActions-f.rst

    .. sip:method:: PyQt5.QtGui.QStandardItemModel.takeColumn
        :args:
            int
        :returns:
            List[:sip:ref:`~PyQt5.QtGui.QStandardItem`]
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.takeHorizontalHeaderItem
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtGui.QStandardItem`
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.takeItem
        :args:
            int
            column: int = 0
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.takeRow
        :args:
            int
        :returns:
            List[:sip:ref:`~PyQt5.QtGui.QStandardItem`]
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.takeVerticalHeaderItem
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtGui.QStandardItem`
    ...
    .. sip:method:: PyQt5.QtGui.QStandardItemModel.verticalHeaderItem
        :args:
            int
        :returns:
            :sip:ref:`~PyQt5.QtGui.QStandardItem`
    ...
    .. sip:signal:: PyQt5.QtGui.QStandardItemModel.itemChanged
        :args:
            :sip:ref:`~PyQt5.QtGui.QStandardItem`

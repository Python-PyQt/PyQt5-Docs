...
.. sip:class:: PyQt5.QtGui.QTransform
    :description: QtGui/QTransform-c.rst

    .. sip:enum:: PyQt5.QtGui.QTransform.TransformationType
        :description: QtGui/QTransform-TransformationType-e.rst

        .. sip:enum-member:: PyQt5.QtGui.QTransform.TransformationType.TxNone
            :description: QtGui/QTransform-TransformationType-TxNone-v.rst

        .. sip:enum-member:: PyQt5.QtGui.QTransform.TransformationType.TxProject
            :description: QtGui/QTransform-TransformationType-TxProject-v.rst

        .. sip:enum-member:: PyQt5.QtGui.QTransform.TransformationType.TxRotate
            :description: QtGui/QTransform-TransformationType-TxRotate-v.rst

        .. sip:enum-member:: PyQt5.QtGui.QTransform.TransformationType.TxScale
            :description: QtGui/QTransform-TransformationType-TxScale-v.rst

        .. sip:enum-member:: PyQt5.QtGui.QTransform.TransformationType.TxShear
            :description: QtGui/QTransform-TransformationType-TxShear-v.rst

        .. sip:enum-member:: PyQt5.QtGui.QTransform.TransformationType.TxTranslate
            :description: QtGui/QTransform-TransformationType-TxTranslate-v.rst

    .. sip:method:: PyQt5.QtGui.QTransform.__init__
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.__add__
        :args:
            float
        :returns:
            :sip:ref:`~PyQt5.QtGui.QTransform`
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.adjoint
        :returns:
            :sip:ref:`~PyQt5.QtGui.QTransform`
        :description: QtGui/QTransform-adjoint-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.determinant
        :returns:
            float
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.dy
        :returns:
            float
        :description: QtGui/QTransform-dy-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.__eq__
        :args:
            :sip:ref:`~PyQt5.QtGui.QTransform`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.fromScale
        :args:
            float
            float
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.fromTranslate
        :args:
            float
            float
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.__hash__
        :returns:
            int
        :description: QtGui/QTransform-__hash__-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.__iadd__
        :args:
            float
        :returns:
            :sip:ref:`~PyQt5.QtGui.QTransform`
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.__imul__
        :args:
            :sip:ref:`~PyQt5.QtGui.QTransform`
        :returns:
            :sip:ref:`~PyQt5.QtGui.QTransform`
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.inverted
        :returns:
            :sip:ref:`~PyQt5.QtGui.QTransform`
            bool
        :description: QtGui/QTransform-inverted-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.isAffine
        :returns:
            bool
        :description: QtGui/QTransform-isAffine-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.isIdentity
        :returns:
            bool
        :description: QtGui/QTransform-isIdentity-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.isInvertible
        :returns:
            bool
        :description: QtGui/QTransform-isInvertible-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.isRotating
        :returns:
            bool
        :description: QtGui/QTransform-isRotating-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.isScaling
        :returns:
            bool
        :description: QtGui/QTransform-isScaling-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.isTranslating
        :returns:
            bool
        :description: QtGui/QTransform-isTranslating-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.__isub__
        :args:
            float
        :returns:
            :sip:ref:`~PyQt5.QtGui.QTransform`
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.m12
        :returns:
            float
        :description: QtGui/QTransform-m12-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.m13
        :returns:
            float
        :description: QtGui/QTransform-m13-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.m21
        :returns:
            float
        :description: QtGui/QTransform-m21-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.m22
        :returns:
            float
        :description: QtGui/QTransform-m22-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.m23
        :returns:
            float
        :description: QtGui/QTransform-m23-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.m31
        :returns:
            float
        :description: QtGui/QTransform-m31-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.m32
        :returns:
            float
        :description: QtGui/QTransform-m32-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.m33
        :returns:
            float
        :description: QtGui/QTransform-m33-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.map
        :args:
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.mapRect
        :args:
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.mapToPolygon
        :args:
            :sip:ref:`~PyQt5.QtCore.QRect`
        :returns:
            :sip:ref:`~PyQt5.QtGui.QPolygon`
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.__matmul__
        :args:
            :sip:ref:`~PyQt5.QtGui.QTransform`
        :returns:
            :sip:ref:`~PyQt5.QtGui.QTransform`
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.__mul__
        :args:
            :sip:ref:`~PyQt5.QtGui.QTransform`
        :returns:
            :sip:ref:`~PyQt5.QtGui.QTransform`
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.__ne__
        :args:
            :sip:ref:`~PyQt5.QtGui.QTransform`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.quadToQuad
        :args:
            :sip:ref:`~PyQt5.QtGui.QPolygonF`
            :sip:ref:`~PyQt5.QtGui.QPolygonF`
            :sip:ref:`~PyQt5.QtGui.QTransform`
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.quadToSquare
        :args:
            :sip:ref:`~PyQt5.QtGui.QPolygonF`
            :sip:ref:`~PyQt5.QtGui.QTransform`
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.reset
        :description: QtGui/QTransform-reset-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.rotate
        :args:
            float
            axis: :sip:ref:`~PyQt5.QtCore.Qt.Axis` = :sip:ref:`~PyQt5.QtCore.Qt.Axis.ZAxis`
        :returns:
            :sip:ref:`~PyQt5.QtGui.QTransform`
        :description: QtGui/QTransform-rotate-f.rst

    .. sip:method:: PyQt5.QtGui.QTransform.rotateRadians
        :args:
            float
            axis: :sip:ref:`~PyQt5.QtCore.Qt.Axis` = :sip:ref:`~PyQt5.QtCore.Qt.Axis.ZAxis`
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.scale
        :args:
            float
            float
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.setMatrix
        :args:
            float
            float
            float
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.shear
        :args:
            float
            float
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.squareToQuad
        :args:
            :sip:ref:`~PyQt5.QtGui.QPolygonF`
            :sip:ref:`~PyQt5.QtGui.QTransform`
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.__sub__
        :args:
            float
        :returns:
            :sip:ref:`~PyQt5.QtGui.QTransform`
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.translate
        :args:
            float
            float
        :returns:
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.transposed
        :returns:
            :sip:ref:`~PyQt5.QtGui.QTransform`
    ...
    .. sip:method:: PyQt5.QtGui.QTransform.type
        :returns:
            :sip:ref:`~PyQt5.QtGui.QTransform.TransformationType`

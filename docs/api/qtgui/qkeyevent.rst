...
.. sip:class:: PyQt5.QtGui.QKeyEvent
    ...
    .. sip:method:: PyQt5.QtGui.QKeyEvent.count
        :returns:
            int
        :description: QtGui/QKeyEvent-count-f.rst

    .. sip:method:: PyQt5.QtGui.QKeyEvent.__eq__
        :args:
    ...
    .. sip:method:: PyQt5.QtGui.QKeyEvent.isAutoRepeat
        :returns:
            bool
        :description: QtGui/QKeyEvent-isAutoRepeat-f.rst

    .. sip:method:: PyQt5.QtGui.QKeyEvent.key
        :returns:
            int
        :description: QtGui/QKeyEvent-key-f.rst

    .. sip:method:: PyQt5.QtGui.QKeyEvent.__len__
        :returns:
            int
        :description: QtGui/QKeyEvent-__len__-f.rst

    .. sip:method:: PyQt5.QtGui.QKeyEvent.matches
        :args:
            :sip:ref:`~PyQt5.QtGui.QKeySequence.StandardKey`
        :returns:
            bool
    ...
    .. sip:method:: PyQt5.QtGui.QKeyEvent.text
        :returns:
            str

...
The :sip:ref:`~PyQt5.Qt3DExtras.QDiffuseMapMaterial` provides a default implementation of the phong lighting effect where the diffuse light component is read from a texture map.

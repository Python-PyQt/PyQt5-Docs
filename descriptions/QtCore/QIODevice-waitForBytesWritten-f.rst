...
If called from within a slot connected to the :sip:ref:`~PyQt5.QtCore.QIODevice.bytesWritten` signal, :sip:ref:`~PyQt5.QtCore.QIODevice.bytesWritten` will not be reemitted.
...
.. seealso:: :sip:ref:`~PyQt5.QtCore.QIODevice.waitForReadyRead`.

...
Constructs a :sip:ref:`~PyQt5.QtCore.QTemporaryFile` with a template filename of *templateName*. Upon opening the temporary file this will be used to create a unique filename.

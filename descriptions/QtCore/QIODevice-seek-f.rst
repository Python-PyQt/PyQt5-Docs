...
When subclassing :sip:ref:`~PyQt5.QtCore.QIODevice`, you must call  at the start of your function to ensure integrity with :sip:ref:`~PyQt5.QtCore.QIODevice`'s built-in buffer.

.. seealso:: :sip:ref:`~PyQt5.QtCore.QIODevice.pos`, :sip:ref:`~PyQt5.QtCore.QIODevice.isSequential`.

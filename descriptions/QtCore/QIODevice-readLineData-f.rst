...
This function is called by :sip:ref:`~PyQt5.QtCore.QIODevice.readLine`, and provides its base implementation, using :sip:ref:`~PyQt5.QtCore.QIODevice.getChar`. Buffered devices can improve the performance of :sip:ref:`~PyQt5.QtCore.QIODevice.readLine` by reimplementing this function.

:sip:ref:`~PyQt5.QtCore.QIODevice.readLine` appends a '\\0' byte to *data*;  does not need to do this.

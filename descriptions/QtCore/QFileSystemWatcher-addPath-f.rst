...
If *path* specifies a directory, the :sip:ref:`~PyQt5.QtCore.QFileSystemWatcher.directoryChanged` signal will be emitted when *path* is modified or removed from disk; otherwise the :sip:ref:`~PyQt5.QtCore.QFileSystemWatcher.fileChanged` signal is emitted when *path* is modified, renamed or removed.
...
.. seealso:: :sip:ref:`~PyQt5.QtCore.QFileSystemWatcher.addPaths`, :sip:ref:`~PyQt5.QtCore.QFileSystemWatcher.removePath`.

...
Calling :sip:ref:`~PyQt5.QtCore.QTextStream.readLine` is better if you do not know how much data is available.

.. seealso:: :sip:ref:`~PyQt5.QtCore.QTextStream.readLine`.

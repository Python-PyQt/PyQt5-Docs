.. sip:class-description::
    ...
    :digest: 63ecbfed5200455fd287b90e2a537a1d

The :sip:ref:`~PyQt5.QtCore.QMimeDatabase` class maintains a database of MIME types.

The MIME type database is provided by the freedesktop.org shared-mime-info project. If the MIME type database cannot be found on the system, as is the case on most Windows, `macOS <https://doc.qt.io/qt-5/qtwebengine-platform-notes.html#macos>`_, and iOS systems, Qt will use its own copy of it.
...
.. seealso:: :sip:ref:`~PyQt5.QtCore.QMimeType`, `MIME Type Browser Example <https://doc.qt.io/qt-5/qtcore-mimetypes-mimetypebrowser-example.html>`_.

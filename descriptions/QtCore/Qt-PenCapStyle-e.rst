...
This enum type defines the pen cap styles supported by Qt, i.e. the line end caps that can be drawn using :sip:ref:`~PyQt5.QtGui.QPainter`.
...
.. seealso:: :sip:ref:`~PyQt5.QtGui.QPen`.

...
Writes a text element with *name*, prefixed for the specified *namespaceUri*, and *text*. If the namespace has not been declared, :sip:ref:`~PyQt5.QtCore.QXmlStreamWriter` will generate a namespace declaration for it.

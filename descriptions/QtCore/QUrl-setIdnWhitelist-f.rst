...
Note that if you call this function, you need to do so *before* you start any threads that might access :sip:ref:`~PyQt5.QtCore.QUrl.idnWhitelist`.
...
.. seealso:: :sip:ref:`~PyQt5.QtCore.QUrl.idnWhitelist`.

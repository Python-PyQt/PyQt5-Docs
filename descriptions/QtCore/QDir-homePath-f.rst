...
Use the :sip:ref:`~PyQt5.QtCore.QDir.toNativeSeparators` function to convert the separators to the ones that are appropriate for the underlying operating system.
...
#. The path returned by the :sip:ref:`~PyQt5.QtCore.QDir.rootPath` function (which uses the ``SystemDrive`` environment variable)

#. The ``C:/`` directory.

Under non-Windows operating systems the ``HOME`` environment variable is used if it exists, otherwise the path returned by the :sip:ref:`~PyQt5.QtCore.QDir.rootPath`.

.. seealso:: :sip:ref:`~PyQt5.QtCore.QDir.home`, :sip:ref:`~PyQt5.QtCore.QDir.currentPath`, :sip:ref:`~PyQt5.QtCore.QDir.rootPath`, :sip:ref:`~PyQt5.QtCore.QDir.tempPath`.

.. sip:method-description::
    ...
    :digest: 9a0e6775602b7cd5ac4a3ac1cd93a260
...
Call :sip:ref:`~PyQt5.QtCore.QCommandLineParser.value` if you expect the option to be present only once, and :sip:ref:`~PyQt5.QtCore.QCommandLineParser.values` if you expect that option to be present multiple times.

.. seealso:: :sip:ref:`~PyQt5.QtCore.QCommandLineOption.valueName`.

...
This is a convenience function for when you're only concerned with parsing XML elements. The `QXmlStream Bookmarks Example <https://doc.qt.io/qt-5/qtxml-streambookmarks-example.html>`_ makes extensive use of this function.

.. seealso:: :sip:ref:`~PyQt5.QtCore.QXmlStreamReader.readNext`.

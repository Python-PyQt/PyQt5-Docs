.. sip:method-description::
    :status: todo
    :pysig: cb823a509616369784be621eb8ba6fd8
...
This function returns an empty :sip:ref:`~PyQt5.QtCore.QByteArray` if *domain* is not a valid hostname. Note, in particular, that IPv6 literals are not valid domain names.

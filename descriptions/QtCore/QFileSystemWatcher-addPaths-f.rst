...
If a path specifies a directory, the :sip:ref:`~PyQt5.QtCore.QFileSystemWatcher.directoryChanged` signal will be emitted when the path is modified or removed from disk; otherwise the :sip:ref:`~PyQt5.QtCore.QFileSystemWatcher.fileChanged` signal is emitted when the path is modified, renamed, or removed.
...
.. seealso:: :sip:ref:`~PyQt5.QtCore.QFileSystemWatcher.addPath`, :sip:ref:`~PyQt5.QtCore.QFileSystemWatcher.removePaths`.

...
When reimplementing :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.insertRows` in a subclass, you must call this function *before* inserting data into the model's underlying data store.
...
**Note:** This function emits the :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.rowsAboutToBeInserted` signal which connected views (or proxies) must handle before the data is inserted. Otherwise, the views may end up in an invalid state.

.. seealso:: :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.endInsertRows`.

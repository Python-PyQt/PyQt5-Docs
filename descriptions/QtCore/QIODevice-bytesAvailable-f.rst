...
Subclasses that reimplement this function must call the base implementation in order to include the size of the buffer of :sip:ref:`~PyQt5.QtCore.QIODevice`. Example:

.. literalinclude:: ../../../snippets/qtbase-src-corelib-doc-snippets-code-src_corelib_io_qiodevice.py
    :lines: 68-71

.. seealso:: :sip:ref:`~PyQt5.QtCore.QIODevice.bytesToWrite`, :sip:ref:`~PyQt5.QtCore.QIODevice.readyRead`, :sip:ref:`~PyQt5.QtCore.QIODevice.isSequential`.

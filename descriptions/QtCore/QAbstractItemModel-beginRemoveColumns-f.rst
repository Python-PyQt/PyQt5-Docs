...
When reimplementing :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.removeColumns` in a subclass, you must call this function *before* removing data from the model's underlying data store.
...
**Note:** This function emits the :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.columnsAboutToBeRemoved` signal which connected views (or proxies) must handle before the data is removed. Otherwise, the views may end up in an invalid state.

.. seealso:: :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.endRemoveColumns`.

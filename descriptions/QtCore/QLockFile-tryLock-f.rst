...
Note: Passing a negative number as the *timeout* is equivalent to calling :sip:ref:`~PyQt5.QtCore.QLockFile.lock`, i.e. this function will wait forever until the lock file can be locked if *timeout* is negative.

If the lock was obtained, it must be released with :sip:ref:`~PyQt5.QtCore.QLockFile.unlock` before another process (or thread) can successfully lock it.
...
.. seealso:: :sip:ref:`~PyQt5.QtCore.QLockFile.lock`, :sip:ref:`~PyQt5.QtCore.QLockFile.unlock`.

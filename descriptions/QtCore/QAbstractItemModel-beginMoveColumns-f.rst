...
When reimplementing a subclass, this method simplifies moving entities in your model. This method is responsible for moving persistent indexes in the model, which you would otherwise be required to do yourself. Using  and :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.endMoveColumns` is an alternative to emitting :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.layoutAboutToBeChanged` and :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.layoutChanged` directly along with :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.changePersistentIndex`.
...
.. seealso:: :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.endMoveColumns`.

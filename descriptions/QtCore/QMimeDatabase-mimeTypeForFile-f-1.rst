.. sip:method-description::
    :status: todo
    :pysig: f2387a171eca3b9a152af82ddd72acdc
...
When *mode* is set to :sip:ref:`~PyQt5.QtCore.QMimeDatabase.MatchMode.MatchExtension`, only the file name is used, not the file contents. The file doesn't even have to exist. If the file name doesn't match any known pattern, the default MIME type (application/octet-stream) is returned. If multiple MIME types match this file, the first one (alphabetically) is returned.

When *mode* is set to :sip:ref:`~PyQt5.QtCore.QMimeDatabase.MatchMode.MatchContent`, and the file is readable, only the file contents are used to determine the MIME type. This is equivalent to calling :sip:ref:`~PyQt5.QtCore.QMimeDatabase.mimeTypeForData` with a :sip:ref:`~PyQt5.QtCore.QFile` as input device.

*fileInfo* may refer to an absolute or relative path.

.. seealso:: :sip:ref:`~PyQt5.QtCore.QMimeType.isDefault`, :sip:ref:`~PyQt5.QtCore.QMimeDatabase.mimeTypeForData`.

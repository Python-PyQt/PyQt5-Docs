...
If you reimplement this function in your custom model, you must also reimplement the member functions that call it: :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.mimeData` and :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.dropMimeData`.

.. seealso:: :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.mimeData`, :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.dropMimeData`.

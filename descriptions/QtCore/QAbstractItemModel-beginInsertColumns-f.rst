.. sip:method-description::
    :status: todo
    :pysig: 8d0a23bedcb57a8eea7fa37ecdb67e0e
    :realsig: (const QModelIndex&,int,int)
    :digest: 03be28d394b4355ab1aa41b85f2286af

Begins a column insertion operation.

When reimplementing :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.insertColumns` in a subclass, you must call this function *before* inserting data into the model's underlying data store.
...
**Note:** This function emits the :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.columnsAboutToBeInserted` signal which connected views (or proxies) must handle before the data is inserted. Otherwise, the views may end up in an invalid state.

.. seealso:: :sip:ref:`~PyQt5.QtCore.QAbstractItemModel.endInsertColumns`.

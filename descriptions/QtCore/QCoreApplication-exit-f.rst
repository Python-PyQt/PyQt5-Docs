.. sip:method-description::
    ...
    :realsig: (int)
    :digest: e7a493f838039534aa79215aa934b7e2

Tells the application to exit with a return code.

After this function has been called, the application leaves the main event loop and returns from the call to :sip:ref:`~PyQt5.QtCore.QCoreApplication.exec`. The :sip:ref:`~PyQt5.QtCore.QCoreApplication.exec` function returns *returnCode*. If the event loop is not running, this function does nothing.
...
.. seealso:: :sip:ref:`~PyQt5.QtCore.QCoreApplication.quit`, :sip:ref:`~PyQt5.QtCore.QCoreApplication.exec`.

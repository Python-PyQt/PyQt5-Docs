.. sip:method-description::
    :status: todo
    :pysig: c8359b270e3493d0dbe8b1a4ed815f0a
    :realsig: (QRunnable*,int)
    :digest: 3b4b86415bf24befb417098402a7b053

Reserves a thread and uses it to run *runnable*, unless this thread will make the current thread count exceed :sip:ref:`~PyQt5.QtCore.QThreadPool.maxThreadCount`. In that case, *runnable* is added to a run queue instead. The *priority* argument can be used to control the run queue's order of execution.

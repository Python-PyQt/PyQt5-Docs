...
If false is returned, a system error has occurred. Call :sip:ref:`~PyQt5.QtCore.QSystemSemaphore.error` to get a value of :sip:ref:`~PyQt5.QtCore.QSystemSemaphore.SystemSemaphoreError` that indicates which error occurred.

.. seealso:: :sip:ref:`~PyQt5.QtCore.QSystemSemaphore.release`.

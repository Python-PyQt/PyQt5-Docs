...
If the application changes its mind while saving, it can call , which sets an error code so that :sip:ref:`~PyQt5.QtCore.QSaveFile.commit` will discard the temporary file.

Alternatively, it can simply make sure not to call :sip:ref:`~PyQt5.QtCore.QSaveFile.commit`.
...
.. seealso:: :sip:ref:`~PyQt5.QtCore.QSaveFile.commit`.

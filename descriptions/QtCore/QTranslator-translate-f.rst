...
If you need to programatically insert translations into a :sip:ref:`~PyQt5.QtCore.QTranslator`, this function can be reimplemented.

.. seealso:: :sip:ref:`~PyQt5.QtCore.QTranslator.load`.

.. sip:class-description::
    ...
    :digest: 57c7fb35d030ea8b2c0d258b2934e966
...
The class can generate 32-bit or 64-bit quantities, or fill an array of those. The most common way of generating new values is to call the :sip:ref:`~PyQt5.QtCore.QRandomGenerator.generate`, :sip:ref:`~PyQt5.QtCore.QRandomGenerator.generate64` or fillRange() functions. One would use it as:

.. literalinclude:: ../../../snippets/qtbase-src-corelib-doc-snippets-code-src_corelib_global_qrandom.py
    :lines: 44-44

Additionally, it provides a floating-point function :sip:ref:`~PyQt5.QtCore.QRandomGenerator.generateDouble` that returns a number in the range [0, 1) (that is, inclusive of zero and exclusive of 1). There's also a set of convenience functions that facilitate obtaining a random number in a bounded, integral range.
...
QRandomGenerator::global(), like all generators created by :sip:ref:`~PyQt5.QtCore.QRandomGenerator.securelySeeded`, is always seeded from QRandomGenerator::system(), so it's not possible to make it produce identical sequences.

...
If *name* contains a relative file path, the path will be relative to the current working directory. You can use :sip:ref:`~PyQt5.QtCore.QDir.tempPath` to construct *name* if you want use the system's temporary directory.

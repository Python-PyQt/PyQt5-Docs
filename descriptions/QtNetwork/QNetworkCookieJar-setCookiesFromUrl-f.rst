.. sip:method-description::
    :status: todo
    :pysig: a66bd31422212e1a3719e92a6ded7af0
...
Also, :sip:ref:`~PyQt5.QtNetwork.QNetworkCookieJar` does not have a maximum cookie jar size. Reimplement this function to discard older cookies to create room for new ones.

.. seealso:: :sip:ref:`~PyQt5.QtNetwork.QNetworkCookieJar.cookiesForUrl`, :sip:ref:`~PyQt5.QtNetwork.QNetworkAccessManager.setCookieJar`, :sip:ref:`~PyQt5.QtNetwork.QNetworkCookie.normalize`.

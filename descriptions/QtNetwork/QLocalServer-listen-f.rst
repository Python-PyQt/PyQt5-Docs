...
*name* can be a single name and :sip:ref:`~PyQt5.QtNetwork.QLocalServer` will determine the correct platform specific path. :sip:ref:`~PyQt5.QtNetwork.QLocalServer.serverName` will return the name that is passed into listen.
...
.. seealso:: :sip:ref:`~PyQt5.QtNetwork.QLocalServer.serverName`, :sip:ref:`~PyQt5.QtNetwork.QLocalServer.isListening`, :sip:ref:`~PyQt5.QtNetwork.QLocalServer.close`.

...
Setting the prefix length also sets the netmask (see :sip:ref:`~PyQt5.QtNetwork.QNetworkAddressEntry.netmask`).

.. seealso:: :sip:ref:`~PyQt5.QtNetwork.QNetworkAddressEntry.prefixLength`, :sip:ref:`~PyQt5.QtNetwork.QNetworkAddressEntry.setNetmask`.

.. sip:method-description::
    ...
    :digest: 831cc79a2b16effe4e2963c2a0b4cbc9

Sets the outgoing option *opt* to value *value*. See the Options section for more information on outgoing options.

.. seealso:: :sip:ref:`~PyQt5.QtNetwork.QAuthenticator.options`, :sip:ref:`~PyQt5.QtNetwork.QAuthenticator.option`, QAuthenticator options.

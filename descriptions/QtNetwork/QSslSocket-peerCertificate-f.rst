...
Because the peer certificate is set during the handshake phase, it is safe to access the peer certificate from a slot connected to the :sip:ref:`~PyQt5.QtNetwork.QSslSocket.sslErrors` signal or the :sip:ref:`~PyQt5.QtNetwork.QSslSocket.encrypted` signal.
...
If you want to check the peer's complete chain of certificates, use :sip:ref:`~PyQt5.QtNetwork.QSslSocket.peerCertificateChain` to get them all at once.

.. seealso:: :sip:ref:`~PyQt5.QtNetwork.QSslSocket.peerCertificateChain`.

.. sip:class-description::
    ...
    :digest: 36a96ec1785d09a31a42f76fd9ad98d5

The :sip:ref:`~PyQt5.QtNetwork.QNetworkCookie` class holds one network cookie.
...
:sip:ref:`~PyQt5.QtNetwork.QNetworkCookie` provides a way of parsing a cookie from the HTTP header format using the :sip:ref:`~PyQt5.QtNetwork.QNetworkCookie.parseCookies` function. However, when received in a :sip:ref:`~PyQt5.QtNetwork.QNetworkReply`, the cookie is already parsed.
...
.. seealso:: :sip:ref:`~PyQt5.QtNetwork.QNetworkCookieJar`, :sip:ref:`~PyQt5.QtNetwork.QNetworkRequest`, :sip:ref:`~PyQt5.QtNetwork.QNetworkReply`.

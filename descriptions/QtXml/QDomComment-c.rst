.. sip:class-description::
    ...
    :digest: 686d256d3fdbbfb61287891922309007

The :sip:ref:`~PyQt5.QtXml.QDomComment` class represents an XML comment.
...
is represented by :sip:ref:`~PyQt5.QtXml.QDomComment` objects in the parsed Dom tree.

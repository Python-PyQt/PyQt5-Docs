...
The :sip:ref:`~PyQt5.Qt3DRender.QCullFace` class specifies whether front or back face culling is enabled.

:sip:ref:`~PyQt5.Qt3DRender.QCullFace` sets whether the front or back facets are culled. Facets include triangles, quadrilaterals, polygons and rectangles.

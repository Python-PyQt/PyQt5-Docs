...
A :sip:ref:`~PyQt5.Qt3DRender.QMultiSampleAntiAliasing` class enables multisample antialiasing.
...
**Note:** When using OpenGL as the graphics API, glEnable(GL_MULTISAMPLE) will be called if :sip:ref:`~PyQt5.Qt3DRender.QMultiSampleAntiAliasing` has been added to the render states.

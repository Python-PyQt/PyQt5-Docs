...
The :sip:ref:`~PyQt5.Qt3DRender.QLayer` class provides a way of filtering which entities will be rendered.

:sip:ref:`~PyQt5.Qt3DRender.QLayer` works in conjunction with the :sip:ref:`~PyQt5.Qt3DRender.QLayerFilter` in the FrameGraph.

A :sip:ref:`~PyQt5.Qt3DRender.QLayer` can be applied to a subtree of entities by setting the recursive property to true.
...
.. seealso:: :sip:ref:`~PyQt5.Qt3DRender.QLayerFilter`.

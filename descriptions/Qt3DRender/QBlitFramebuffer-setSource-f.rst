...
**Note:** As with other nodes, *source* gets automatically parented to the :sip:ref:`~PyQt5.Qt3DRender.QBlitFramebuffer` instance when no parent has been set. The lifetime is also tracked, meaning the source reverts to nullptr in case the currently set *source* is destroyed.

.. seealso:: :sip:ref:`~PyQt5.Qt3DRender.QBlitFramebuffer.source`.

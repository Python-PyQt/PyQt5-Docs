.. sip:method-description::
    :status: todo
    :pysig: 3522ecb50ad96247382d70e53d773649
...
**Note:** As with other nodes, *destination* gets automatically parented to the :sip:ref:`~PyQt5.Qt3DRender.QBlitFramebuffer` instance when no parent has been set. The lifetime is also tracked, meaning the destination reverts to nullptr in case the currently set *destination* is destroyed.

.. seealso:: :sip:ref:`~PyQt5.Qt3DRender.QBlitFramebuffer.destination`.

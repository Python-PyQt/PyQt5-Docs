.. sip:class-description::
    ...
    :digest: 2fcb0acad039cde2e63cd3d0722d9dd7

The :sip:ref:`~PyQt5.Qt3DRender.QLevelOfDetail` class provides a way of controlling the complexity of rendered entities based on their size on the screen.

:sip:ref:`~PyQt5.Qt3DRender.QLevelOfDetail` can be used to control the representation of an entity based on distance from the observer or size on the screen.
...
The `LevelOfDetail <https://doc.qt.io/qt-5/qml-qt3d-render-levelofdetail.html>`_ component is not shareable between multiple `entities <https://doc.qt.io/qt-5/qml-qt3d-core-entity.html>`_.

...
If set to :sip:ref:`~PyQt5.Qt3DAnimation.QAbstractClipAnimator.Loops.Infinite`, the animation will continuously repeat until it is explicitly stopped.

.. seealso:: :sip:ref:`~PyQt5.Qt3DAnimation.QAbstractClipAnimator.setLoopCount`.

...
To populate the model with the table's data, call :sip:ref:`~PyQt5.QtSql.QSqlTableModel.select`.

Error information can be retrieved with lastError().

.. seealso:: :sip:ref:`~PyQt5.QtSql.QSqlTableModel.select`, :sip:ref:`~PyQt5.QtSql.QSqlTableModel.setFilter`, lastError().

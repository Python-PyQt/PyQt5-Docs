...
Retrieves the record at position *index*, if available, and positions the query on the retrieved record. The first record is at position 0. Note that the query must be in an :sip:ref:`~PyQt5.QtSql.QSqlQuery.isActive` state and :sip:ref:`~PyQt5.QtSql.QSqlQuery.isSelect` must return true before calling this function.
...
.. seealso:: :sip:ref:`~PyQt5.QtSql.QSqlQuery.next`, :sip:ref:`~PyQt5.QtSql.QSqlQuery.previous`, :sip:ref:`~PyQt5.QtSql.QSqlQuery.first`, :sip:ref:`~PyQt5.QtSql.QSqlQuery.last`, :sip:ref:`~PyQt5.QtSql.QSqlQuery.at`, :sip:ref:`~PyQt5.QtSql.QSqlQuery.isActive`, :sip:ref:`~PyQt5.QtSql.QSqlQuery.isValid`.

...
An invalid :sip:ref:`~PyQt5.QtCore.QVariant` is returned if field *index* does not exist, if the query is inactive, or if the query is positioned on an invalid record.

...
To remove the default connection, which may have been created with a call to :sip:ref:`~PyQt5.QtSql.QSqlDatabase.addDatabase` not specifying a connection name, you can retrieve the default connection name by calling :sip:ref:`~PyQt5.QtSql.QSqlDatabase.connectionName` on the database returned by :sip:ref:`~PyQt5.QtSql.QSqlDatabase.database`. Note that if a default database hasn't been created an invalid database will be returned.

.. seealso:: :sip:ref:`~PyQt5.QtSql.QSqlDatabase.database`, :sip:ref:`~PyQt5.QtSql.QSqlDatabase.connectionName`.

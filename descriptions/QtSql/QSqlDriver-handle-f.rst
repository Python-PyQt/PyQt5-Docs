...
Returns the low-level database handle wrapped in a :sip:ref:`~PyQt5.QtCore.QVariant` or an invalid variant if there is no handle.
...
.. seealso:: :sip:ref:`~PyQt5.QtSql.QSqlResult.handle`.

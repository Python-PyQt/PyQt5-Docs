.. sip:method-description::
    ...
    :digest: 80741f58214fbd369cd0113492cd1802

Sets database-specific *options*. This must be done before the connection is opened, otherwise it has no effect. Another possibility is to close the connection, call , and :sip:ref:`~PyQt5.QtSql.QSqlDatabase.open` the connection again.
...
| DB2                      | OCI                        | TDS    |
+==========================+============================+========+
| * SQL_ATTR_ACCESS_MODE   | * OCI_ATTR_PREFETCH_ROWS   | *none* |
|                          |                            |        |
...
.. seealso:: :sip:ref:`~PyQt5.QtSql.QSqlDatabase.connectOptions`.

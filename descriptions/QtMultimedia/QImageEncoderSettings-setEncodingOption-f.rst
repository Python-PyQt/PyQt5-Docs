.. sip:method-description::
    ...
    :digest: 62006f277087aa97d0ced1ef3e69ea30

Set the encoding *option* *value*.

The supported set and meaning of encoding options are system and selected codec specific.

.. seealso:: :sip:ref:`~PyQt5.QtMultimedia.QImageEncoderSettings.encodingOption`, :sip:ref:`~PyQt5.QtMultimedia.QImageEncoderSettings.setEncodingOptions`.

.. sip:method-description::
    :status: todo
    :pysig: d7407383e9f914adc31833c08582b49d
...
The *flags* argument is optional and currently only supports :sip:ref:`~PyQt5.QtCore.Qt.TextFlag.TextShowMnemonic` as value.

The elide mark follows the :sip:ref:`~PyQt5.QtCore.Qt.LayoutDirection`. For example, it will be on the right side of the text for right-to-left layouts if the *mode* is ``Qt::ElideLeft``, and on the left side of the text if the *mode* is ``Qt::ElideRight``.

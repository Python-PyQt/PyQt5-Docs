...
**Note:** It is only possible to split cells that span multiple rows or columns, such as rows that have been merged using :sip:ref:`~PyQt5.QtGui.QTextTable.mergeCells`.

.. seealso:: :sip:ref:`~PyQt5.QtGui.QTextTable.mergeCells`.

.. sip:enum-description::
    :status: todo
    :digest: 0a3305fe42066a0feac3e7ffbd66a81d

This enum type lists the available page sizes as defined in the Postscript PPD standard. These values are duplicated in :sip:ref:`~PyQt5.QtGui.QPagedPaintDevice` and QPrinter.

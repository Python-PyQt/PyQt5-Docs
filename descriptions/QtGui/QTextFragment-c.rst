...
The :sip:ref:`~PyQt5.QtGui.QTextFragment` class holds a piece of text in a :sip:ref:`~PyQt5.QtGui.QTextDocument` with a single :sip:ref:`~PyQt5.QtGui.QTextCharFormat`.
...
A fragment's text and character format can be obtained with the :sip:ref:`~PyQt5.QtGui.QTextFragment.text` and :sip:ref:`~PyQt5.QtGui.QTextFragment.charFormat` functions. The :sip:ref:`~PyQt5.QtGui.QTextFragment.length` function gives the length of the text in the fragment. :sip:ref:`~PyQt5.QtGui.QTextFragment.position` gives the position in the document of the start of the fragment. To determine whether the fragment contains a particular position within the document, use the :sip:ref:`~PyQt5.QtGui.QTextFragment.contains` function.

.. seealso:: :sip:ref:`~PyQt5.QtGui.QTextDocument`, `Rich Text Document Structure <https://doc.qt.io/qt-5/richtext-structure.html>`_.

...
The :sip:ref:`~PyQt5.QtGui.QTextLength` class encapsulates the different types of length used in a :sip:ref:`~PyQt5.QtGui.QTextDocument`.
...
.. seealso:: :sip:ref:`~PyQt5.QtGui.QTextTable`.

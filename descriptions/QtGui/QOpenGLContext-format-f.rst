...
Returns the format of the underlying platform context, if :sip:ref:`~PyQt5.QtGui.QOpenGLContext.create` has been called.
...
.. seealso:: :sip:ref:`~PyQt5.QtGui.QOpenGLContext.setFormat`.

...
The *formatVersion* parameter may be used to *create* a :sip:ref:`~PyQt5.QtGui.QPicture` that can be read by applications that are compiled with earlier versions of Qt.

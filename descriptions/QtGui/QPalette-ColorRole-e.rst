.. sip:enum-description::
    :status: todo
    :digest: 1195da7e946d8081aa1863b7b655c9c0
...
Note that we do not use the ``Link`` and ``LinkVisited`` roles when rendering rich text in Qt, and that we recommend that you use CSS and the :sip:ref:`~PyQt5.QtGui.QTextDocument.setDefaultStyleSheet` function to alter the appearance of links. For example:

...
Requests a second session management phase for the application. The application may then return immediately from the :sip:ref:`~PyQt5.QtGui.QGuiApplication.commitDataRequest` or QApplication::saveStateRequest() function, and they will be called again once most or all other applications have finished their session management.
...
.. seealso:: :sip:ref:`~PyQt5.QtGui.QSessionManager.isPhase2`.

...
The next call to :sip:ref:`~PyQt5.QtGui.QImageReader.read` will attempt to read this image.

.. seealso:: :sip:ref:`~PyQt5.QtGui.QImageReader.jumpToNextImage`, :sip:ref:`~PyQt5.QtGui.QImageIOHandler.jumpToImage`.

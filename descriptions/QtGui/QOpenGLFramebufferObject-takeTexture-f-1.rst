...
If the framebuffer object is currently bound, an implicit :sip:ref:`~PyQt5.QtGui.QOpenGLFramebufferObject.release` will be done. During the next call to :sip:ref:`~PyQt5.QtGui.QOpenGLFramebufferObject.bind` a new texture will be created.

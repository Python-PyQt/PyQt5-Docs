.. sip:method-description::
    :status: todo
    :pysig: 783b5a7012a3bdf710227cdd8ad22f9b
    :realsig: (QImage::InvertMode)
    :digest: aac4885a29c9d486a8b252d595443b6d

Inverts all pixel values in the image.

The given invert *mode* only have a meaning when the image's depth is 32. The default *mode* is :sip:ref:`~PyQt5.QtGui.QImage.InvertMode.InvertRgb`, which leaves the alpha channel unchanged. If the *mode* is :sip:ref:`~PyQt5.QtGui.QImage.InvertMode.InvertRgba`, the alpha bits are also inverted.

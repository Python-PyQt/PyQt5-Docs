...
The :sip:ref:`~PyQt5.QtGui.QOpenGLDebugMessage` class wraps an OpenGL debug message.
...
It's also possible for applications or third-party libraries and toolkits to create and insert messages in the debug log. In order to do so, you can use the :sip:ref:`~PyQt5.QtGui.QOpenGLDebugMessage.createApplicationMessage` or the :sip:ref:`~PyQt5.QtGui.QOpenGLDebugMessage.createThirdPartyMessage` static functions.

.. seealso:: :sip:ref:`~PyQt5.QtGui.QOpenGLDebugLogger`.

...
The :sip:ref:`~PyQt5.QtGui.QStyleHints` class contains platform specific hints and settings.

An object of this class, obtained from :sip:ref:`~PyQt5.QtGui.QGuiApplication`, provides access to certain global user interface parameters of the current platform.
...
.. seealso:: :sip:ref:`~PyQt5.QtGui.QGuiApplication.styleHints`.

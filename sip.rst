The main purpose of the :mod:`~PyQt5.sip` module is to provide
...
.. class:: array
    ...
    :class:`~PyQt5.sip.array` object can be created from a
    :class:`~PyQt5.sip.voidptr` object by calling
    :func:`~PyQt5.sip.voidptr.asarray`.  This allows the underlying
    memory (interpreted as a sequence of unsigned bytes) to be processed much
    more quickly.
...
.. function:: getapi(name) -> version
    ...
    :func:`~PyQt5.sip.setapi` or implicitly by importing the module
    that defines it.
...
.. class:: simplewrapper
    ...
    use the default :class:`~PyQt5.sip.wrapper` type but do not
...
.. class:: voidptr
    ...
    .. method:: __init__(address[, size=-1[, writeable=True]])
        ...
        :param address:
            the address, either another :class:`~PyQt5.sip.voidptr`,
            ``None``, a Python Capsule, an object that implements the buffer
        ...
        :param writeable:
            ...
            *address* is a :class:`~PyQt5.sip.voidptr` instance then
    ...
    .. method:: asarray([size=-1]) -> :class:`~PyQt5.sip.array`

        This returned the block of memory as an
        :class:`~PyQt5.sip.array` object.  The memory is *not*
        copied.
        ...
        :param size:
            ...
            exception is raised.
        :return:
            the :class:`~PyQt5.sip.array` object.

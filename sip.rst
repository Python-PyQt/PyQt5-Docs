...
.. py:class:: array
    ...
    :py:class:`~PyQt5.sip.array` object can be created from a
    :py:class:`~PyQt5.sip.voidptr` object by calling
    :py:func:`~PyQt5.sip.voidptr.asarray`.  This allows the
...
.. py:class:: simplewrapper
    ...
    use the default :py:class:`~PyQt5.sip.wrapper` type but do not
...
.. py:class:: voidptr
    ...
    .. py:method:: __init__(address, size=-1, writeable=True)
        ...
        :param address:
            ...
            :py:class:`~PyQt5.sip.voidptr`, ``None``, a Python
        ...
        :param bool writeable:
            ...
            *address* is a :py:class:`~PyQt5.sip.voidptr` instance
    ...
    .. py:method:: __getitem__(idx)
        ...
        :return:
            ...
            :py:class:`~PyQt5.sip.voidptr` object defining the
    ...
    .. py:method:: asarray(size=-1)
        ...
        :param int size:
            ...
            exception is raised.
        :return:
            the :py:class:`~PyQt5.sip.array` object.
